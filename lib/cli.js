...
cli.version = (function cli$version$() {
  /* cli.version /Users/jbr/code/sibilant/src/cli.sibilant:35:0 */

  return console.log(sibilant.versionString());
});
cli.repl = (function cli$repl$(args) {
  /* cli.repl /Users/jbr/code/sibilant/src/cli.sibilant:38:0 */

  return require("../lib/repl");
});
var readStdin = (function readStdin$(fn) {
  /* read-stdin /Users/jbr/code/sibilant/src/cli.sibilant:40:0 */
  ...
  stdin.on("data", (function(chunk) {
    /* /Users/jbr/code/sibilant/src/cli.sibilant:45:21 */
  
    return data = (data + chunk);
  }));
  return stdin.on("end", (function() {
    /* /Users/jbr/code/sibilant/src/cli.sibilant:46:20 */
  
    return fn(data);
  }));
});
cli.eval = (function cli$eval$(args, options) {
  /* cli.eval /Users/jbr/code/sibilant/src/cli.sibilant:48:0 */

  options.execute = true;
  return cli.input(args, options);
});
cli.input = (function cli$input$(args, options) {
  /* cli.input /Users/jbr/code/sibilant/src/cli.sibilant:52:0 */

  var process = (function process$(sibilantCode) {
    /* process /Users/jbr/code/sibilant/src/cli.sibilant:53:5 */
...
cli.help = (function cli$help$(args, options) {
  /* cli.help /Users/jbr/code/sibilant/src/cli.sibilant:62:0 */

  return fs.readFile((__dirname + "/../cli-help"), { encoding: "utf8" }, (function(err, data) {
    /* /Users/jbr/code/sibilant/src/cli.sibilant:64:19 */
...
(cliOptions.file || []).forEach((function(inputFile) {
  /* /Users/jbr/code/sibilant/src/cli.sibilant:77:0 */

...
var runInSandbox = (function runInSandbox$(js, inputPath) {
  /* run-in-sandbox src/cli.sibilant:9:0 */
...
(function() {
  if (((typeof cliOptions.file === "undefined" || 0 === cliOptions.file.length) && cliOptions.docs)) {
    sibilant.include("./include/macros.sibilant");
    return console.log(sibilant.docs[sibilant.sibilize(cliOptions.docs[0])]());
  }
}).call(this);
(cliOptions.file || []).forEach((function(inputFile) {
  /* src/cli.sibilant:82:0 */

...
cli.help = (function(args) {
  ...
  "\n" +
  "--output DIR / -o DIR  Output input files to this dir, replacing .sib with .js.\n" +
  "\n" +
  ...
  "$ sibilant -x myfile.sib -- --arg-for-my-program=stuff\n" +
  "\n" +
  "myfile.sib will see process.argv as\n" +
  "[ 'sibilant', 'myfile.sib', '--arg-for-my-program=stuff' ]\n" +
  "\n" +
  "--------------------------------------------------------------------------------\n" +
  "\n" +
  "Examples\n" +
  ...
  "$ npm link .\n" +
  "$ sibilant src/*.sib -o lib\n" +
  "$ sibilant -x test/test.sib # you're now running a sibilant you just compiled.\n" +
  "\n" +
  "to compile one file to stdout\n" +
  "$ sibilant test/test.sib\n" +
  "\n" +
  "to compile a file to a directory\n" +
  "$ sibilant test/test.sib -o . # put test.js here\n" +
  "or\n" +
  "$ sibilant --input test/test.sib --output .\n" +
  "\n" +
  "to run a file\n" +
  "$ sibilant -x test/test.sib\n" +
  "\n" +
  "to enter the repl\n" +
  "$ sibilant\n" +
  "or\n" +
...
(cliOptions.input || [  ]).forEach((function(inputFile) {
  ...
  return (function() {
    if (outputDir) {
      var inputBasename = path.basename(inputPath, ".sib"),

...
(function(root) {
  ...
  sibilant.macros.namespaces.core.apply = (function apply$(fn, arglist) {
    ...
    return macros.expandQuote.call(this, "37550", {
      "37554": fn,
      "37559": arglist
    });
  });
  ...
  sibilant.macros.namespaces.core.append = (function append$(list, additional) {
    ...
    return macros.expandQuote.call(this, "37690", {
      "37694": list,
      "37701": additional
    });
  });
  sibilant.macros.namespaces.core.length = (function length$(arr) {
    ...
    return macros.expandQuote.call(this, "37754", { "37757": arr });
  });
  sibilant.macros.namespaces.core.scoped = (function scoped$(body) {
    ...
    return macros.expandQuote.call(this, "37827", {
      "37834": {
        node: this,
        args: []
      },
  ...
  sibilant.macros.namespaces.core["_scopedWithoutSource"] = (function _scopedWithoutSource$(body) {
    ...
    return [ "(function() {", indent(macros.expandQuote.call(this, "37882", { "37886": body })), "}).call(this)" ];
  });
  sibilant.macros.namespaces.core["_numberWords"] = (function _numberWords$(numberWords) {
    ...
    return numberWords.forEach((function(word, index) {
      ...
      macros.expandQuote.call(this, "37961", {
        "37964": ("fetches the " + outputFormatter(transpile(word)) + " element from `arr`"),
        "38022": word
      });
      return macros.expandQuote.call(this, "38063", {
        "38066": word,
        "38078": index
      });
    }));
  ...
  sibilant.macros.namespaces.core["_defInfix"] = (function _defInfix$(macroName, word, jsComparator) {
    ...
    macros.expandQuote.call(this, "38972", {
      "38975": docstring,
      "38983": macroName,
      "38994": macroName
    });
    return macros.expandQuote.call(this, "39021", {
      "39024": macroName,
      "39052": (jsComparator || [ "\"", macroName, "\"" ])
    });
  });
  sibilant.macros.namespaces.core[">"] = (function $$(args) {
  ...
  sibilant.macros.namespaces.core.new = (function new$(constructor, args) {
    ...
    return [ "(new ", macros.expandQuote.call(this, "39504", {
      "39507": constructor,
      "39511": args
    }), ")" ];
  });
  sibilant.macros.namespaces.core.regex = (function regex$(pattern, flags) {
    ...
    return macros.expandQuote.call(this, "39573", {
      "39578": pattern,
      "39581": (flags || "undefined")
    });
  });
  ...
  sibilant.macros.namespaces.core["zero__QUERY"] = (function zero__QUERY$(item) {
    ...
    return macros.expandQuote.call(this, "39681", { "39684": item });
  });
  sibilant.macros.namespaces.core["empty__QUERY"] = (function empty__QUERY$(arr) {
    ...
    return macros.expandQuote.call(this, "39732", { "39740": arr });
  });
  sibilant.macros.namespaces.core["odd__QUERY"] = (function odd__QUERY$(number) {
    ...
    return macros.expandQuote.call(this, "39785", { "39793": number });
  });
  sibilant.macros.namespaces.core["even__QUERY"] = (function even__QUERY$(number) {
    ...
    return macros.expandQuote.call(this, "39840", { "39848": number });
  });
  ...
  sibilant.macros.namespaces.core["string__QUERY"] = (function string__QUERY$(things) {
    ...
    return macros.expandQuote.call(this, "39957", { "39961": map(things, (function(thing) {
      /* /Users/jbr/code/sibilant/include/macros.sibilant:282:29 */
    
      return macros.expandQuote.call(this, "39974", { "39980": thing });
    })) });
  });
  sibilant.macros.namespaces.core["function__QUERY"] = (function function__QUERY$(things) {
    ...
    return macros.expandQuote.call(this, "40045", { "40049": map(things, (function(thing) {
      /* /Users/jbr/code/sibilant/include/macros.sibilant:288:29 */
    
      return macros.expandQuote.call(this, "40062", { "40068": thing });
    })) });
  });
  sibilant.macros.namespaces.core["undefined__QUERY"] = (function undefined__QUERY$(things) {
    ...
    return macros.expandQuote.call(this, "40153", { "40157": map(things, (function(thing) {
      /* /Users/jbr/code/sibilant/include/macros.sibilant:297:29 */
    
      return macros.expandQuote.call(this, "40170", { "40176": thing });
    })) });
  });
  sibilant.macros.namespaces.core["defined__QUERY"] = (function defined__QUERY$(things) {
    ...
    return macros.expandQuote.call(this, "40261", { "40265": map(things, (function(thing) {
      /* /Users/jbr/code/sibilant/include/macros.sibilant:305:29 */
    
      return macros.expandQuote.call(this, "40278", { "40284": thing });
    })) });
  });
  ...
  sibilant.macros.namespaces.core.if = (function if$(arg, truebody, falsebody) {
    ...
    return [ "(function() {", indent([ "if (", transpile(arg), ") {", indent(macros.expandQuote.call(this, "40463", { "40467": truebody })), "} else {", indent(macros.expandQuote.call(this, "40526", { "40530": falsebody })), "}" ]), "}).call(this)" ];
  });
          ...
          return (function() {
            ...
            var cloned = (function() {
              if (node__QUERY(item, "literal", "dots")) {
                return macros.expandQuote.call(this, "41096", { "41097": item }).source;
              } else {
                return clone(item);
              }
            }).call(this);
  ...
  sibilant.macros.namespaces.core.comment = (function comment$(contents) {
    /* comment /Users/jbr/code/sibilant/include/macros.sibilant:361:0 */
  
    var contents = Array.prototype.slice.call(arguments, 0);
  
    return map(contents, (function(content) {
      /* /Users/jbr/code/sibilant/include/macros.sibilant:362:21 */
    
      return [ "// ", recurseMap(transpile(content), (function(item) {
        /* /Users/jbr/code/sibilant/include/macros.sibilant:364:36 */
  ...
  sibilant.macros.namespaces.core.when = (function when$(condition, body) {
    ...
    return [ "(function() {", indent([ "if (", transpile(condition), ") {", indent(macros.expandQuote.call(this, "42053", { "42057": body })), "}" ]), "}).call(this)" ];
  });
  ...
  sibilant.macros.namespaces.core.unless = (function unless$(condition, body) {
    ...
    return [ "(function() {", indent([ "if (", macros.expandQuote.call(this, "42280", { "42283": condition }), ") {", indent(macros.expandQuote.call(this, "42317", { "42321": body })), "}" ]), "}).call(this)" ];
  });
  ...
  sibilant.macros.namespaces.core.logPretty = (function logPretty$(label, arg) {
    ...
    return macros.expandQuote.call(this, "42731", {
      "42737": [ "\"", node.file, ":", node.line, "\"" ],
      "42752": label,
      "42760": arg
    });
  });
  sibilant.macros.namespaces.core.each = (function each$(item, array, body) {
    ...
    return macros.expandQuote.call(this, "42978", {
      "42982": array,
      "43007": {
        node: this,
        args: (function() {
  ...
  sibilant.macros.namespaces.core.try = (function try$(tryblock, catchblock) {
    ...
    return [ "(function() {", indent([ "try {", indent(macros.expandQuote.call(this, "43378", { "43381": tryblock })), "} catch (e) {", indent(macros.expandQuote.call(this, "43426", { "43429": catchblock })), "}" ]), "}).call(this)" ];
  });
  ...
  sibilant.macros.namespaces.core.while = (function while$(condition, body) {
    ...
    return macros.expandQuote.call(this, "43801", {
      "43816": symbol,
      "43829": [ "while (", transpile(condition), ") {", indent(macros.expandQuote.call(this, "43856", {
        "43859": symbol,
        "43866": body
      })), "}" ],
      "43896": symbol
  ...
  sibilant.macros.namespaces.core.until = (function until$(condition, body) {
    ...
    return macros.expandQuote.call(this, "43965", {
      "43971": condition,
      "43976": body
    });
  });
  sibilant.macros.namespaces.core["match__QUERY"] = (function match__QUERY$(regexp, string) {
    ...
    return macros.expandQuote.call(this, "44035", {
      "44039": string,
      "44042": regexp
    });
  });
  sibilant.macros.namespaces.core["matchRegex__QUERY"] = (function matchRegex__QUERY$(string, pattern, flags) {
    ...
    return macros.expandQuote.call(this, "44095", {
      "44101": pattern,
      "44104": flags,
      "44108": string
    });
  ...
  sibilant.macros.namespaces.core.replace = (function replace$(string, pattern, replacement) {
    ...
    return macros.expandQuote.call(this, "44161", {
      "44165": string,
      "44185": pattern,
      "44203": replacement
    });
  ...
  sibilant.macros.namespaces.core.replaceAll = (function replaceAll$(string, pattern, replacement) {
    ...
    return macros.expandQuote.call(this, "44255", {
      "44259": string,
      "44265": pattern,
      "44272": replacement
    });
  ...
  sibilant.macros.namespaces.core.thunk = (function thunk$(body) {
    ...
    return macros.expandQuote.call(this, "44382", {
      "44385": {
        node: this,
        args: []
      },
      "44407": mapNode(body, (function(node) {
        /* /Users/jbr/code/sibilant/include/macros.sibilant:608:17 */
      
        return (function() {
          if (node__QUERY(node, "argPlaceholder")) {
            return macros.expandQuote.call(this, "44491", { "44494": node.token.replace((new RegExp("^#", undefined)), "") });
          } else {
            return node;
          }
        }).call(this);
  ...
  sibilant.macros.namespaces.core.argument = (function argument$(index) {
    ...
    return macros.expandQuote.call(this, "45103", { "45108": index });
  });
  sibilant.macros.namespaces.core.eachKey = (function eachKey$(as, obj, body) {
    ...
    return macros.expandQuote.call(this, "45177", {
      "45180": obj,
      "45208": {
        args: (function() {
  ...
  sibilant.macros.namespaces.core.switch = (function switch$(obj, cases) {
    ...
    return [ "(function() {", indent([ "switch(", transpile(obj), ") {", map(cases, (function(caseDef) {
      ...
      return [ "\n", caseString, indent(macros.expandQuote.call(this, "46276", { "46280": caseDef.contents.slice(1) })) ];
    })), "}" ]), "}).call(this)" ];
  });
    ...
    return [ "(function() {", indent(interleave(" else ", bulkMap(alternatingConditionsAndBranches, (function(cond, val) {
      ...
      return (function() {
        if (typeof val !== "undefined") {
          return [ "if (", transpile(cond), ") {", indent(macros.expandQuote.call(this, "46901", { "46904": val })), "}" ];
        } else {
          return [ "{", indent(macros.expandQuote.call(this, "46987", { "46990": cond })), "}" ];
        }
      }).call(this);
    })))), "}).call(this)" ];
  });
  sibilant.macros.namespaces.core.chain = (function chain$(object, calls) {
    ...
    return (function() {
      if (0 === calls.length) {
        ...
        return macros.expandQuote.call(this, "47129", {
          "47132": object,
          "47136": calls[0].contents
        });
      } else {
  ...
  sibilant.macros.namespaces.core.chainable = (function chainable$(names) {
    ...
    return names.forEach((function(name) {
      ...
      return macros.expandQuote.call(this, "47466", { "47469": name });
    }));
  });
  ...
  sibilant.macros.namespaces.core["includes__QUERY"] = (function includes__QUERY$(haystack, needle) {
    ...
    return macros.expandQuote.call(this, "47661", {
      "47664": haystack,
      "47671": needle
    });
  });
  sibilant.macros.namespaces.core["excludes__QUERY"] = (function excludes__QUERY$(haystack, needle) {
    ...
    return macros.expandQuote.call(this, "47753", {
      "47756": haystack,
      "47763": needle
    });
  });
  sibilant.macros.namespaces.core["exists__QUERY"] = (function exists__QUERY$(thing) {
    ...
    return macros.expandQuote.call(this, "47818", {
      "47824": thing,
      "47831": thing
    });
  });
  ...
  sibilant.macros.namespaces.core.join = (function join$(arr, glue) {
    ...
    return macros.expandQuote.call(this, "48105", {
      "48109": arr,
      "48112": (glue || "\"\"")
    });
  });
      ...
      return (function() {
        ...
        case "bracket":
          ...
          lhs.contents.forEach((function(item, index) {
            ...
            return destructured.push([ transpile(item), macros.expandQuote.call(this, "48587", {
              "48590": symbol,
              "48593": index
            }) ]);
          }));
        ...
        case "brace":
          ...
          lhs.contents.forEach((function(item, index) {
            ...
            return destructured.push([ trItem, macros.expandQuote.call(this, "48920", {
              "48923": symbol,
              "48926": [ "\"", trItem, "\"" ]
            }) ]);
          }));
  ...
  sibilant.macros.namespaces.core.default = (function default$(pairs) {
    ...
    return interleave("\n", bulkMap(pairs, (function(name, value) {
      ...
      return macros.expandQuote.call(this, "49363", {
        "49366": name,
        "49375": name,
        "49379": name,
        "49382": value
  ...
  sibilant.macros.namespaces.core.namespace = (function namespace$(namespace) {
    ...
    macros.expandQuote.call(this, "49510", { "49513": namespace });
  ...
  sibilant.macros.namespaces.core["hasKey__QUERY"] = (function hasKey__QUERY$(object, key) {
    ...
    return macros.expandQuote.call(this, "49608", {
      "49612": object,
      "49615": key
    });
  });
  ...
  sibilant.macros.namespaces.core.set = (function set$(arr, kvPairs) {
    ...
    return interleave("\n", bulkMap(kvPairs, (function(k, v) {
      ...
      return macros.expandQuote.call(this, "50235", {
        "50241": arr,
        "50244": k,
        "50248": v
      });
  ...
  sibilant.macros.namespaces.core["lowerCase__QUERY"] = (function lowerCase__QUERY$(str) {
    ...
    return macros.expandQuote.call(this, "50294", {
      "50301": str,
      "50305": str
    });
  });
  sibilant.macros.namespaces.core["upperCase__QUERY"] = (function upperCase__QUERY$(str) {
    ...
    return macros.expandQuote.call(this, "50350", {
      "50357": str,
      "50361": str
    });
  });

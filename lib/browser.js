  ...
  transpile.hat = (function transpile$hat$(node) {
    ...
    var token = node.contents[0].token,
      ...
      if (token.match((new RegExp("\/", undefined)))) {
        ...
        macro = $_symbol6_$[1],
        $_symbol6_$ = undefined;
    return sibilant.macros.namespaces.core.get.call(node, "sibilant.macros.namespaces", sibilant.macros.namespaces.core.quote(namespace), sibilant.macros.namespaces.core.quote(macro));
  });

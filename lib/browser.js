  ...
  sibilant.macros.namespaces.core.quote = (function sibilant$macros$namespaces$core$quote$(content) {
    ...
    return (function() {
      if (typeof content === "string") {
        ...
        return sibilant.macros.namespaces.core.call("sibilant.macros.namespace.expandQuote.call", "this", JSON.stringify(content), sibilant.macros.namespaces.core.quotedHash.apply(this, alternatingKeysAndValues(unquotes)));

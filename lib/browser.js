...
(function(root) {
  ...
  var mapValues = (function mapValues$(object, fn) {
    ...
    return inject({  }, Object.keys(object), (function(collector, key, index) {
      ...
      (collector)[key] = fn(key, (object)[key]);
      return collector;
    }));
  });
  ...
  restructurers.openExpression = (function restructurers$openExpression$(token, context) {
    /* restructurers.open-expression /Users/jbr/code/sibilant/src/restructurer.sibilant:26:0 */
  ...
  restructurers.closeExpression = (function restructurers$closeExpression$(node, context, index) {
    /* restructurers.close-expression /Users/jbr/code/sibilant/src/restructurer.sibilant:38:0 */
  ...
  var openSpecial = (function openSpecial$(node, context) {
    /* open-special /Users/jbr/code/sibilant/src/restructurer.sibilant:56:0 */
  ...
  var acceptSpecials = (function acceptSpecials$(node, context) {
    /* accept-specials /Users/jbr/code/sibilant/src/restructurer.sibilant:68:0 */
  ...
  var closeSpecials = (function closeSpecials$(node, context) {
    /* close-specials /Users/jbr/code/sibilant/src/restructurer.sibilant:73:0 */
  ...
  restructurers.hat = (function restructurers$hat$(node, context, index) {
    /* restructurers.hat /Users/jbr/code/sibilant/src/restructurer.sibilant:80:0 */
  
    return openSpecial(node, context);
  });
  restructurers.dots = (function restructurers$dots$(node, context, index) {
    /* restructurers.dots /Users/jbr/code/sibilant/src/restructurer.sibilant:81:0 */
  
    return openSpecial(node, context);
  });
  restructurers.tick = (function restructurers$tick$(node, context, index) {
    /* restructurers.tick /Users/jbr/code/sibilant/src/restructurer.sibilant:82:0 */
  
    return openSpecial(node, context);
  });
  restructurers.at = (function restructurers$at$(node, context, index) {
    /* restructurers.at /Users/jbr/code/sibilant/src/restructurer.sibilant:83:0 */
  
    return openSpecial(node, context);
  });
  restructurers.whitespace = (function restructurers$whitespace$(token, context, index) {
    /* restructurers.whitespace /Users/jbr/code/sibilant/src/restructurer.sibilant:85:0 */
  
    return context;
  });
  restructurers.newline = (function restructurers$newline$(token, context, index) {
    /* restructurers.newline /Users/jbr/code/sibilant/src/restructurer.sibilant:86:0 */
  
    return context;
  });
  restructurers.ignored = (function restructurers$ignored$(token, context, index) {
    /* restructurers.ignored /Users/jbr/code/sibilant/src/restructurer.sibilant:87:0 */
  
    return context;
  });
  restructurers.default = (function restructurers$default$(token, context, index) {
    /* restructurers.default /Users/jbr/code/sibilant/src/restructurer.sibilant:89:0 */
  ...
  macros.concat = (function macros$concat$(args) {
    /* ^concat /Users/jbr/code/sibilant/src/macros.sibilant:105:0 */
  ...
  macros.reverse = (function macros$reverse$(arr) {
    /* ^reverse /Users/jbr/code/sibilant/src/macros.sibilant:108:0 */
  
    var reversed = [];
    arr.forEach((function(item) {
      /* /Users/jbr/code/sibilant/src/macros.sibilant:110:5 */
  ...
  macros.lambda = (function macros$lambda$(argsOrOptions, body) {
    /* ^lambda /Users/jbr/code/sibilant/src/macros.sibilant:115:0 */
    ...
    var args = ((argsOrOptions)["args"] || argsOrOptions),
      ...
      /* /Users/jbr/code/sibilant/src/macros.sibilant:126:23 */
    
      return node__QUERY(arg, "dots");
    }));
    var thisNode = this,
        node = detect([ thisNode, argsOrOptions.node, argsOrOptions.name, args, (body)[0] ], (function(n) {
      /* /Users/jbr/code/sibilant/src/macros.sibilant:131:16 */
  ...
  macros.quotedHash = (function macros$quotedHash$(pairs) {
    /* ^quoted-hash /Users/jbr/code/sibilant/src/macros.sibilant:149:0 */
  ...
  var logPretty = (function logPretty$(label, arg) {
    /* log-pretty /Users/jbr/code/sibilant/src/macros.sibilant:180:0 */
  
    console.log((label + ": " + prettify(arg)));
    return arg;
  });
  macros.quote = (function macros$quote$(content) {
    /* ^quote /Users/jbr/code/sibilant/src/macros.sibilant:184:0 */
    ...
    return (function() {
      if (typeof(content) === "string") {
        ...
        return macros.call("expandQuote", macros.quote(content.nodeId), macros.quotedHash.apply(this, alternatingKeysAndValues(findUnquotes(content))));
      } else {
  ...
  macros.debug = (function macros$debug$(val) {
    /* ^debug /Users/jbr/code/sibilant/src/macros.sibilant:195:0 */
  
    (sibilant)["debug"] = eval(outputFormatter(transpile(val)));
    return null;
  });
  var mapNode = (function mapNode$(node, fn) {
    /* map-node /Users/jbr/code/sibilant/src/macros.sibilant:198:0 */
      ...
      if (node__QUERY(node)) {
        ...
        return (function() {
          if (node__QUERY(mappedNode)) {
            return mergeWith(mappedNode, { contents: mapNode(node.contents, fn) });
          } else {
            return mappedNode;
          }
        })();
      } else if (((node) && typeof (node) === "object" && (node).constructor.name === "Array")) {
        return map(node, (function(c) {
          /* /Users/jbr/code/sibilant/src/macros.sibilant:205:32 */
  ...
  var eachNode = (function eachNode$(node, fn) {
    /* each-node /Users/jbr/code/sibilant/src/macros.sibilant:208:0 */
    ...
    return (function() {
      if (node__QUERY(node)) {
        ...
        return node.forEach((function(c) {
          /* /Users/jbr/code/sibilant/src/macros.sibilant:210:22 */
  ...
  var expandQuote = (function expandQuote$(nodeId, expansions) {
    /* expand-quote /Users/jbr/code/sibilant/src/macros.sibilant:213:0 */
  
    var expandedNodes = mapNode((sibilant.nodeCache)[nodeId], (function(node) {
      /* /Users/jbr/code/sibilant/src/macros.sibilant:215:35 */
    
      return logPretty(nodeId, (function() {
        if (node__QUERY(node)) {
          return ((expansions)[node.nodeId] || clone(node));
        } else {
          return node;
        }
      })());
  ...
  var unquote__QUERY = (function unquote__QUERY$(node) {
    /* unquote? /Users/jbr/code/sibilant/src/macros.sibilant:223:0 */
  
    return node__QUERY(node, "at");
  });
  var findUnquotes = (function findUnquotes$(node) {
    /* find-unquotes /Users/jbr/code/sibilant/src/macros.sibilant:226:0 */
  
    var unquotes = {  };
    eachNode(node, (function(n) {
      /* /Users/jbr/code/sibilant/src/macros.sibilant:228:21 */
  ...
  var alternatingKeysAndValues = (function alternatingKeysAndValues$(hash) {
    /* alternating-keys-and-values /Users/jbr/code/sibilant/src/macros.sibilant:234:0 */
  
    return flatten(map(Object.keys(hash), (function(key) {
      /* /Users/jbr/code/sibilant/src/macros.sibilant:236:19 */
    
      return [ key, (hash)[key] ];
    })));
  });
  macros.list = (function macros$list$(args) {
    /* ^list /Users/jbr/code/sibilant/src/macros.sibilant:239:0 */
    ...
    return (function() {
      if (((args).length === 0)) {
        ...
        var simpleList = (function simpleList$(args) {
          /* simple-list /Users/jbr/code/sibilant/src/macros.sibilant:243:12 */
        
          return [ "[ ", interleave(", ", map(args, (function(arg) {
            /* /Users/jbr/code/sibilant/src/macros.sibilant:244:50 */
          
            return arg.transpiled;
          }))), " ]" ];
        });
        args.forEach((function(arg) {
          /* /Users/jbr/code/sibilant/src/macros.sibilant:246:27 */
        ...
        argSegments = map(argSegments, (function(segment) {
          /* /Users/jbr/code/sibilant/src/macros.sibilant:252:38 */
  ...
  macros.call = (function macros$call$(fnName, args) {
    /* ^call /Users/jbr/code/sibilant/src/macros.sibilant:262:0 */
  
    var args = Array.prototype.slice.call(arguments, 1);
  
    
    return (function() {
      if (any__QUERY(args, (function(arg) {
        /* /Users/jbr/code/sibilant/src/macros.sibilant:264:20 */
  ...
  transpile.dots = (function transpile$dots$(node) {
    ...
    var child = (node.contents)[0];
    (child)["dots"] = node.token.length;
    var result = transpile(child);
    (result)["dots"] = node.token.length;
    return result;
  });
  transpile.default = (function transpile$default$(node) {
    /* transpile.default /Users/jbr/code/sibilant/src/transpiler.sibilant:93:0 */
  
    return node.token;
  });
  transpile.output = (function transpile$output$(node) {
    /* transpile.output /Users/jbr/code/sibilant/src/transpiler.sibilant:96:0 */
  
    return node;
  });
  transpile.number = (function transpile$number$(node) {
    /* transpile.number /Users/jbr/code/sibilant/src/transpiler.sibilant:99:0 */
  
    return parseFloat(node.token.replace((new RegExp(",", "g")), "")).toString();
  });
  transpile.root = (function transpile$root$(node) {
    /* transpile.root /Users/jbr/code/sibilant/src/transpiler.sibilant:102:0 */
  ...
  transpile.expression = (function transpile$expression$(node, preprocessor) {
    /* transpile.expression /Users/jbr/code/sibilant/src/transpiler.sibilant:107:0 */
  ...
  transpile.bracket = (function transpile$bracket$(node) {
    /* transpile.bracket /Users/jbr/code/sibilant/src/transpiler.sibilant:126:0 */
  
    return macros.list.apply(this, node.contents);
  });
  transpile.brace = (function transpile$brace$(node) {
    /* transpile.brace /Users/jbr/code/sibilant/src/transpiler.sibilant:129:0 */
  
    return macros.hash.apply(this, node.contents);
  });
  transpile.literal = (function transpile$literal$(node) {
    /* transpile.literal /Users/jbr/code/sibilant/src/transpiler.sibilant:131:0 */
    ...
    return inject(string.replace((new RegExp("\\*", "g")), "_")
      ...
      /* /Users/jbr/code/sibilant/src/transpiler.sibilant:138:13 */
    
      return returnString.replace(match, (match)[1].toUpperCase());
    }));
  });
  transpile.string = (function transpile$string$(node) {
    /* transpile.string /Users/jbr/code/sibilant/src/transpiler.sibilant:142:0 */
  
    return node.token.split("\n")
      .join("\\n\" +\n\"");
  });
  transpile.comment = (function transpile$comment$(node) {
    /* transpile.comment /Users/jbr/code/sibilant/src/transpiler.sibilant:146:0 */
  ...
  sibilant.packageInfo = (function sibilant$packageInfo$() {
    /* sibilant.package-info /Users/jbr/code/sibilant/src/browser.sibilant:23:3 */
  
    return package;
  });
  sibilant.versionString = (function sibilant$versionString$() {
    /* sibilant.version-string /Users/jbr/code/sibilant/src/browser.sibilant:25:3 */
  ...
  return (function() {
    if ((typeof $ !== 'undefined')) {
      return $((function() {
        /* /Users/jbr/code/sibilant/src/browser.sibilant:31:12 */
      
        var sibilant = root.sibilant,
            scripts = $.makeArray($("script[type=\"application/sibilant\"][src]", map((function() {
          /* /Users/jbr/code/sibilant/src/browser.sibilant:34:48 */
        
          return this.src;
        }))));
        sibilant.initialize = (function sibilant$initialize$() {
          /* sibilant.initialize /Users/jbr/code/sibilant/src/browser.sibilant:36:13 */
        
          return false;
        });
        var evalCode = (function evalCode$(js) {
          /* eval-code /Users/jbr/code/sibilant/src/browser.sibilant:39:13 */
        
          return (new Function(js))();
        });
        sibilant.include = (function sibilant$include$(url) {
          /* sibilant.include /Users/jbr/code/sibilant/src/browser.sibilant:42:13 */
        
          return $.get(url, done((function(data) {
            /* /Users/jbr/code/sibilant/src/browser.sibilant:43:35 */
          
            return evalCode(sibilize(data));
          })));
        });
        sibilant.loadMacros = (function sibilant$loadMacros$(fn) {
          /* sibilant.load-macros /Users/jbr/code/sibilant/src/browser.sibilant:45:13 */
        
          return sibilant.include("/javascripts/macros.sibilant").done((function() {
            /* /Users/jbr/code/sibilant/src/browser.sibilant:47:31 */
        ...
        return sibilant.loadMacros().then(map(scripts, sibilant.include));
      }));
    }
  })();
})(this);
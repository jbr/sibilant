...
(function(root) {
  ...
  sibilant.macros.namespaces.core.apply = (function apply$(fn, arglist) {
    ...
    return macros.expandQuote.call(this, "40857", {
      "40861": fn,
      "40866": arglist
    });
  });
  ...
  sibilant.macros.namespaces.core.append = (function append$(list, additional) {
    ...
    return macros.expandQuote.call(this, "40997", {
      "41001": list,
      "41008": additional
    });
  });
  sibilant.macros.namespaces.core.length = (function length$(arr) {
    ...
    return macros.expandQuote.call(this, "41061", { "41064": arr });
  });
  sibilant.macros.namespaces.core.scoped = (function scoped$(body) {
    ...
    return macros.expandQuote.call(this, "41134", {
      "41141": {
        node: this,
        args: []
      },
  ...
  sibilant.macros.namespaces.core["_scopedWithoutSource"] = (function _scopedWithoutSource$(body) {
    ...
    return [ "(function() {", indent(macros.expandQuote.call(this, "41189", { "41193": body })), "}).call(this)" ];
  });
  sibilant.macros.namespaces.core["_numberWords"] = (function _numberWords$(numberWords) {
    ...
    return numberWords.forEach((function(word, index) {
      ...
      macros.expandQuote.call(this, "41268", {
        "41271": ("fetches the " + outputFormatter(transpile(word)) + " element from `arr`"),
        "41329": word
      });
      return macros.expandQuote.call(this, "41370", {
        "41373": word,
        "41385": index
      });
    }));
  ...
  sibilant.macros.namespaces.core["_defInfix"] = (function _defInfix$(macroName, word, jsComparator) {
    ...
    macros.expandQuote.call(this, "42279", {
      "42282": docstring,
      "42290": macroName,
      "42301": macroName
    });
    return macros.expandQuote.call(this, "42328", {
      "42331": macroName,
      "42359": (jsComparator || [ "\"", macroName, "\"" ])
    });
  });
  sibilant.macros.namespaces.core[">"] = (function $$(args) {
  ...
  sibilant.macros.namespaces.core.new = (function new$(constructor, args) {
    ...
    return [ "(new ", macros.expandQuote.call(this, "42811", {
      "42814": constructor,
      "42818": args
    }), ")" ];
  });
  sibilant.macros.namespaces.core.regex = (function regex$(pattern, flags) {
    ...
    return macros.expandQuote.call(this, "42880", {
      "42885": pattern,
      "42888": (flags || "undefined")
    });
  });
  ...
  sibilant.macros.namespaces.core["zero__QUERY"] = (function zero__QUERY$(item) {
    ...
    return macros.expandQuote.call(this, "42988", { "42991": item });
  });
  sibilant.macros.namespaces.core["empty__QUERY"] = (function empty__QUERY$(arr) {
    ...
    return macros.expandQuote.call(this, "43039", { "43047": arr });
  });
  sibilant.macros.namespaces.core["odd__QUERY"] = (function odd__QUERY$(number) {
    ...
    return macros.expandQuote.call(this, "43092", { "43100": number });
  });
  sibilant.macros.namespaces.core["even__QUERY"] = (function even__QUERY$(number) {
    ...
    return macros.expandQuote.call(this, "43147", { "43155": number });
  });
  ...
  sibilant.macros.namespaces.core["string__QUERY"] = (function string__QUERY$(things) {
    ...
    return macros.expandQuote.call(this, "43264", { "43268": map(things, (function(thing) {
      /* /Users/jbr/code/sibilant/include/macros.sibilant:282:29 */
    
      return macros.expandQuote.call(this, "43281", { "43287": thing });
    })) });
  });
  sibilant.macros.namespaces.core["function__QUERY"] = (function function__QUERY$(things) {
    ...
    return macros.expandQuote.call(this, "43352", { "43356": map(things, (function(thing) {
      /* /Users/jbr/code/sibilant/include/macros.sibilant:288:29 */
    
      return macros.expandQuote.call(this, "43369", { "43375": thing });
    })) });
  });
  sibilant.macros.namespaces.core["undefined__QUERY"] = (function undefined__QUERY$(things) {
    ...
    return macros.expandQuote.call(this, "43460", { "43464": map(things, (function(thing) {
      /* /Users/jbr/code/sibilant/include/macros.sibilant:297:29 */
    
      return macros.expandQuote.call(this, "43477", { "43483": thing });
    })) });
  });
  sibilant.macros.namespaces.core["defined__QUERY"] = (function defined__QUERY$(things) {
    ...
    return macros.expandQuote.call(this, "43568", { "43572": map(things, (function(thing) {
      /* /Users/jbr/code/sibilant/include/macros.sibilant:305:29 */
    
      return macros.expandQuote.call(this, "43585", { "43591": thing });
    })) });
  });
  sibilant.macros.namespaces.core["number__QUERY"] = (function number__QUERY$(things) {
    ...
    return macros.expandQuote.call(this, "43658", { "43662": map(things, (function(thing) {
      /* /Users/jbr/code/sibilant/include/macros.sibilant:312:29 */
    
      return macros.expandQuote.call(this, "43675", { "43681": thing });
    })) });
  });
  sibilant.macros.namespaces.core.if = (function if$(arg, truebody, falsebody) {
    ...
    return [ "(function() {", indent([ "if (", transpile(arg), ") {", indent(macros.expandQuote.call(this, "43770", { "43774": truebody })), "} else {", indent(macros.expandQuote.call(this, "43833", { "43837": falsebody })), "}" ]), "}).call(this)" ];
  });
          ...
          return (function() {
            ...
            var cloned = (function() {
              if (node__QUERY(item, "literal", "dots")) {
                return macros.expandQuote.call(this, "44403", { "44404": item }).source;
              } else {
                return clone(item);
              }
            }).call(this);
  ...
  sibilant.macros.namespaces.core.when = (function when$(condition, body) {
    ...
    return [ "(function() {", indent([ "if (", transpile(condition), ") {", indent(macros.expandQuote.call(this, "45259", { "45263": body })), "}" ]), "}).call(this)" ];
  });
  ...
  sibilant.macros.namespaces.core.unless = (function unless$(condition, body) {
    ...
    return [ "(function() {", indent([ "if (", macros.expandQuote.call(this, "45486", { "45489": condition }), ") {", indent(macros.expandQuote.call(this, "45523", { "45527": body })), "}" ]), "}).call(this)" ];
  });
  ...
  sibilant.macros.namespaces.core.logPretty = (function logPretty$(label, arg) {
    ...
    return macros.expandQuote.call(this, "45937", {
      "45943": [ "\"", node.file, ":", node.line, "\"" ],
      "45958": label,
      "45966": arg
    });
  });
  sibilant.macros.namespaces.core.each = (function each$(item, array, body) {
    ...
    return macros.expandQuote.call(this, "46184", {
      "46188": array,
      "46213": {
        node: this,
        args: (function() {
  ...
  sibilant.macros.namespaces.core.try = (function try$(tryblock, catchblock) {
    ...
    return [ "(function() {", indent([ "try {", indent(macros.expandQuote.call(this, "46584", { "46587": tryblock })), "} catch (e) {", indent(macros.expandQuote.call(this, "46632", { "46635": catchblock })), "}" ]), "}).call(this)" ];
  });
  ...
  sibilant.macros.namespaces.core.while = (function while$(condition, body) {
    ...
    return macros.expandQuote.call(this, "47007", {
      "47022": symbol,
      "47035": [ "while (", transpile(condition), ") {", indent(macros.expandQuote.call(this, "47062", {
        "47065": symbol,
        "47072": body
      })), "}" ],
      "47102": symbol
  ...
  sibilant.macros.namespaces.core.until = (function until$(condition, body) {
    ...
    return macros.expandQuote.call(this, "47171", {
      "47177": condition,
      "47182": body
    });
  });
  sibilant.macros.namespaces.core["match__QUERY"] = (function match__QUERY$(regexp, string) {
    ...
    return macros.expandQuote.call(this, "47241", {
      "47245": string,
      "47248": regexp
    });
  });
  sibilant.macros.namespaces.core["matchRegex__QUERY"] = (function matchRegex__QUERY$(string, pattern, flags) {
    ...
    return macros.expandQuote.call(this, "47301", {
      "47307": pattern,
      "47310": flags,
      "47314": string
    });
  ...
  sibilant.macros.namespaces.core.replace = (function replace$(string, pattern, replacement) {
    ...
    return macros.expandQuote.call(this, "47367", {
      "47371": string,
      "47391": pattern,
      "47409": replacement
    });
  ...
  sibilant.macros.namespaces.core.replaceAll = (function replaceAll$(string, pattern, replacement) {
    ...
    return macros.expandQuote.call(this, "47461", {
      "47465": string,
      "47471": pattern,
      "47478": replacement
    });
  ...
  sibilant.macros.namespaces.core.thunk = (function thunk$(body) {
    ...
    return macros.expandQuote.call(this, "47588", {
      "47591": {
        node: this,
        args: []
      },
      "47613": mapNode(body, (function(node) {
        /* /Users/jbr/code/sibilant/include/macros.sibilant:608:17 */
      
        return (function() {
          if (node__QUERY(node, "argPlaceholder")) {
            return macros.expandQuote.call(this, "47697", { "47700": node.token.replace((new RegExp("^#", undefined)), "") });
          } else {
            return node;
          }
        }).call(this);
  ...
  sibilant.macros.namespaces.core.argument = (function argument$(index) {
    ...
    return macros.expandQuote.call(this, "48309", { "48314": index });
  });
  sibilant.macros.namespaces.core.eachKey = (function eachKey$(as, obj, body) {
    ...
    return macros.expandQuote.call(this, "48383", {
      "48386": obj,
      "48414": {
        args: (function() {
  ...
  sibilant.macros.namespaces.core.switch = (function switch$(obj, cases) {
    ...
    return [ "(function() {", indent([ "switch(", transpile(obj), ") {", map(cases, (function(caseDef) {
      ...
      return [ "\n", caseString, indent(macros.expandQuote.call(this, "49482", { "49486": caseDef.contents.slice(1) })) ];
    })), "}" ]), "}).call(this)" ];
  });
    ...
    return [ "(function() {", indent(interleave(" else ", bulkMap(alternatingConditionsAndBranches, (function(cond, val) {
      ...
      return (function() {
        if (typeof val !== "undefined") {
          return [ "if (", transpile(cond), ") {", indent(macros.expandQuote.call(this, "50107", { "50110": val })), "}" ];
        } else {
          return [ "{", indent(macros.expandQuote.call(this, "50193", { "50196": cond })), "}" ];
        }
      }).call(this);
    })))), "}).call(this)" ];
  });
  sibilant.macros.namespaces.core.chain = (function chain$(object, calls) {
    ...
    return (function() {
      if (0 === calls.length) {
        ...
        return macros.expandQuote.call(this, "50335", {
          "50338": object,
          "50342": calls[0].contents
        });
      } else {
  ...
  sibilant.macros.namespaces.core.chainable = (function chainable$(names) {
    ...
    return names.forEach((function(name) {
      ...
      return macros.expandQuote.call(this, "50672", { "50675": name });
    }));
  });
  ...
  sibilant.macros.namespaces.core["includes__QUERY"] = (function includes__QUERY$(haystack, needle) {
    ...
    return macros.expandQuote.call(this, "50867", {
      "50870": haystack,
      "50877": needle
    });
  });
  sibilant.macros.namespaces.core["excludes__QUERY"] = (function excludes__QUERY$(haystack, needle) {
    ...
    return macros.expandQuote.call(this, "50959", {
      "50962": haystack,
      "50969": needle
    });
  });
  sibilant.macros.namespaces.core["exists__QUERY"] = (function exists__QUERY$(thing) {
    ...
    return macros.expandQuote.call(this, "51024", {
      "51030": thing,
      "51037": thing
    });
  });
  ...
  sibilant.macros.namespaces.core.join = (function join$(arr, glue) {
    ...
    return macros.expandQuote.call(this, "51311", {
      "51315": arr,
      "51318": (glue || "\"\"")
    });
  });
      ...
      return (function() {
        ...
        case "bracket":
          ...
          lhs.contents.forEach((function(item, index) {
            ...
            return destructured.push([ transpile(item), macros.expandQuote.call(this, "51793", {
              "51796": symbol,
              "51799": index
            }) ]);
          }));
        ...
        case "brace":
          ...
          lhs.contents.forEach((function(item, index) {
            ...
            return destructured.push([ trItem, macros.expandQuote.call(this, "52126", {
              "52129": symbol,
              "52132": [ "\"", trItem, "\"" ]
            }) ]);
          }));
  ...
  sibilant.macros.namespaces.core.default = (function default$(pairs) {
    ...
    return interleave("\n", bulkMap(pairs, (function(name, value) {
      ...
      return macros.expandQuote.call(this, "52569", {
        "52572": name,
        "52581": name,
        "52585": name,
        "52588": value
  ...
  sibilant.macros.namespaces.core.namespace = (function namespace$(namespace) {
    ...
    macros.expandQuote.call(this, "52716", { "52719": namespace });
  ...
  sibilant.macros.namespaces.core["hasKey__QUERY"] = (function hasKey__QUERY$(object, key) {
    ...
    return macros.expandQuote.call(this, "52814", {
      "52818": object,
      "52821": key
    });
  });
  ...
  sibilant.macros.namespaces.core.set = (function set$(arr, kvPairs) {
    ...
    return interleave("\n", bulkMap(kvPairs, (function(k, v) {
      ...
      return macros.expandQuote.call(this, "53441", {
        "53447": arr,
        "53450": k,
        "53454": v
      });
  ...
  sibilant.macros.namespaces.core["lowerCase__QUERY"] = (function lowerCase__QUERY$(str) {
    ...
    return macros.expandQuote.call(this, "53500", {
      "53507": str,
      "53511": str
    });
  });
  sibilant.macros.namespaces.core["upperCase__QUERY"] = (function upperCase__QUERY$(str) {
    ...
    return macros.expandQuote.call(this, "53556", {
      "53563": str,
      "53567": str
    });
  });

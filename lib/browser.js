...
(function(root) {
  ...
  sibilant.macros.namespaces.core.apply = (function apply$(fn, arglist) {
    ...
    return macros.expandQuote.call(this, "37449", {
      "37453": fn,
      "37458": arglist
    });
  });
  ...
  sibilant.macros.namespaces.core.append = (function append$(list, additional) {
    ...
    return macros.expandQuote.call(this, "37589", {
      "37593": list,
      "37600": additional
    });
  });
  sibilant.macros.namespaces.core.length = (function length$(arr) {
    ...
    return macros.expandQuote.call(this, "37653", { "37656": arr });
  });
  sibilant.macros.namespaces.core.scoped = (function scoped$(body) {
    ...
    return macros.expandQuote.call(this, "37726", {
      "37733": {
        node: this,
        args: []
      },
  ...
  sibilant.macros.namespaces.core["_scopedWithoutSource"] = (function _scopedWithoutSource$(body) {
    ...
    return [ "(function() {", indent(macros.expandQuote.call(this, "37781", { "37785": body })), "}).call(this)" ];
  });
  sibilant.macros.namespaces.core["_numberWords"] = (function _numberWords$(numberWords) {
    ...
    return numberWords.forEach((function(word, index) {
      ...
      macros.expandQuote.call(this, "37860", {
        "37863": ("fetches the " + outputFormatter(transpile(word)) + " element from `arr`"),
        "37921": word
      });
      return macros.expandQuote.call(this, "37962", {
        "37965": word,
        "37977": index
      });
    }));
  ...
  sibilant.macros.namespaces.core["_defInfix"] = (function _defInfix$(macroName, word, jsComparator) {
    ...
    macros.expandQuote.call(this, "38871", {
      "38874": docstring,
      "38882": macroName,
      "38893": macroName
    });
    return macros.expandQuote.call(this, "38920", {
      "38923": macroName,
      "38951": (jsComparator || [ "\"", macroName, "\"" ])
    });
  });
  sibilant.macros.namespaces.core[">"] = (function $$(args) {
  ...
  sibilant.macros.namespaces.core.new = (function new$(constructor, args) {
    ...
    return [ "(new ", macros.expandQuote.call(this, "39403", {
      "39406": constructor,
      "39410": args
    }), ")" ];
  });
  sibilant.macros.namespaces.core.regex = (function regex$(pattern, flags) {
    ...
    return macros.expandQuote.call(this, "39472", {
      "39477": pattern,
      "39480": (flags || "undefined")
    });
  });
  ...
  sibilant.macros.namespaces.core["zero__QUERY"] = (function zero__QUERY$(item) {
    ...
    return macros.expandQuote.call(this, "39580", { "39583": item });
  });
  sibilant.macros.namespaces.core["empty__QUERY"] = (function empty__QUERY$(arr) {
    ...
    return macros.expandQuote.call(this, "39631", { "39639": arr });
  });
  sibilant.macros.namespaces.core["odd__QUERY"] = (function odd__QUERY$(number) {
    ...
    return macros.expandQuote.call(this, "39684", { "39692": number });
  });
  sibilant.macros.namespaces.core["even__QUERY"] = (function even__QUERY$(number) {
    ...
    return macros.expandQuote.call(this, "39739", { "39747": number });
  });
  ...
  sibilant.macros.namespaces.core["string__QUERY"] = (function string__QUERY$(things) {
    ...
    return macros.expandQuote.call(this, "39856", { "39860": map(things, (function(thing) {
      /* /Users/jbr/code/sibilant/include/macros.sibilant:282:29 */
    
      return macros.expandQuote.call(this, "39873", { "39879": thing });
    })) });
  });
  sibilant.macros.namespaces.core["function__QUERY"] = (function function__QUERY$(things) {
    ...
    return macros.expandQuote.call(this, "39944", { "39948": map(things, (function(thing) {
      /* /Users/jbr/code/sibilant/include/macros.sibilant:288:29 */
    
      return macros.expandQuote.call(this, "39961", { "39967": thing });
    })) });
  });
  sibilant.macros.namespaces.core["undefined__QUERY"] = (function undefined__QUERY$(things) {
    ...
    return macros.expandQuote.call(this, "40052", { "40056": map(things, (function(thing) {
      /* /Users/jbr/code/sibilant/include/macros.sibilant:297:29 */
    
      return macros.expandQuote.call(this, "40069", { "40075": thing });
    })) });
  });
  sibilant.macros.namespaces.core["defined__QUERY"] = (function defined__QUERY$(things) {
    ...
    return macros.expandQuote.call(this, "40160", { "40164": map(things, (function(thing) {
      /* /Users/jbr/code/sibilant/include/macros.sibilant:305:29 */
    
      return macros.expandQuote.call(this, "40177", { "40183": thing });
    })) });
  });
  sibilant.macros.namespaces.core["number__QUERY"] = (function number__QUERY$(things) {
    ...
    return macros.expandQuote.call(this, "40250", { "40254": map(things, (function(thing) {
      /* /Users/jbr/code/sibilant/include/macros.sibilant:312:29 */
    
      return macros.expandQuote.call(this, "40267", { "40273": thing });
    })) });
  });
  sibilant.macros.namespaces.core.if = (function if$(arg, truebody, falsebody) {
    ...
    return [ "(function() {", indent([ "if (", transpile(arg), ") {", indent(macros.expandQuote.call(this, "40362", { "40366": truebody })), "} else {", indent(macros.expandQuote.call(this, "40425", { "40429": falsebody })), "}" ]), "}).call(this)" ];
  });
          ...
          return (function() {
            ...
            var cloned = (function() {
              if (node__QUERY(item, "literal", "dots")) {
                return macros.expandQuote.call(this, "40995", { "40996": item }).source;
              } else {
                return clone(item);
              }
            }).call(this);
  ...
  sibilant.macros.namespaces.core.when = (function when$(condition, body) {
    ...
    return [ "(function() {", indent([ "if (", transpile(condition), ") {", indent(macros.expandQuote.call(this, "41851", { "41855": body })), "}" ]), "}).call(this)" ];
  });
  ...
  sibilant.macros.namespaces.core.unless = (function unless$(condition, body) {
    ...
    return [ "(function() {", indent([ "if (", macros.expandQuote.call(this, "42078", { "42081": condition }), ") {", indent(macros.expandQuote.call(this, "42115", { "42119": body })), "}" ]), "}).call(this)" ];
  });
  ...
  sibilant.macros.namespaces.core.logPretty = (function logPretty$(label, arg) {
    ...
    return macros.expandQuote.call(this, "42529", {
      "42535": [ "\"", node.file, ":", node.line, "\"" ],
      "42550": label,
      "42558": arg
    });
  });
  sibilant.macros.namespaces.core.each = (function each$(item, array, body) {
    ...
    return macros.expandQuote.call(this, "42776", {
      "42780": array,
      "42805": {
        node: this,
        args: (function() {
  ...
  sibilant.macros.namespaces.core.try = (function try$(tryblock, catchblock) {
    ...
    return [ "(function() {", indent([ "try {", indent(macros.expandQuote.call(this, "43176", { "43179": tryblock })), "} catch (e) {", indent(macros.expandQuote.call(this, "43224", { "43227": catchblock })), "}" ]), "}).call(this)" ];
  });
  ...
  sibilant.macros.namespaces.core.while = (function while$(condition, body) {
    ...
    return macros.expandQuote.call(this, "43599", {
      "43614": symbol,
      "43627": [ "while (", transpile(condition), ") {", indent(macros.expandQuote.call(this, "43654", {
        "43657": symbol,
        "43664": body
      })), "}" ],
      "43694": symbol
  ...
  sibilant.macros.namespaces.core.until = (function until$(condition, body) {
    ...
    return macros.expandQuote.call(this, "43763", {
      "43769": condition,
      "43774": body
    });
  });
  sibilant.macros.namespaces.core["match__QUERY"] = (function match__QUERY$(regexp, string) {
    ...
    return macros.expandQuote.call(this, "43833", {
      "43837": string,
      "43840": regexp
    });
  });
  sibilant.macros.namespaces.core["matchRegex__QUERY"] = (function matchRegex__QUERY$(string, pattern, flags) {
    ...
    return macros.expandQuote.call(this, "43893", {
      "43899": pattern,
      "43902": flags,
      "43906": string
    });
  ...
  sibilant.macros.namespaces.core.replaceAll = (function replaceAll$(string, pattern, replacement) {
    ...
    return macros.expandQuote.call(this, "44053", {
      "44057": string,
      "44063": pattern,
      "44070": replacement
    });
  ...
  sibilant.macros.namespaces.core.thunk = (function thunk$(body) {
    ...
    return macros.expandQuote.call(this, "44180", {
      "44183": {
        node: this,
        args: []
      },
      "44205": mapNode(body, (function(node) {
        /* /Users/jbr/code/sibilant/include/macros.sibilant:608:17 */
      
        return (function() {
          if (node__QUERY(node, "argPlaceholder")) {
            return macros.expandQuote.call(this, "44289", { "44292": node.token.replace((new RegExp("^#", undefined)), "") });
          } else {
            return node;
          }
        }).call(this);
  ...
  sibilant.macros.namespaces.core.argument = (function argument$(index) {
    ...
    return macros.expandQuote.call(this, "44901", { "44906": index });
  });
  sibilant.macros.namespaces.core.eachKey = (function eachKey$(as, obj, body) {
    ...
    return macros.expandQuote.call(this, "44975", {
      "44978": obj,
      "45006": {
        args: (function() {
  ...
  sibilant.macros.namespaces.core.switch = (function switch$(obj, cases) {
    ...
    return [ "(function() {", indent([ "switch(", transpile(obj), ") {", map(cases, (function(caseDef) {
      ...
      return [ "\n", caseString, indent(macros.expandQuote.call(this, "46074", { "46078": caseDef.contents.slice(1) })) ];
    })), "}" ]), "}).call(this)" ];
  });
    ...
    return [ "(function() {", indent(interleave(" else ", bulkMap(alternatingConditionsAndBranches, (function(cond, val) {
      ...
      return (function() {
        if (typeof val !== "undefined") {
          return [ "if (", transpile(cond), ") {", indent(macros.expandQuote.call(this, "46699", { "46702": val })), "}" ];
        } else {
          return [ "{", indent(macros.expandQuote.call(this, "46785", { "46788": cond })), "}" ];
        }
      }).call(this);
    })))), "}).call(this)" ];
  });
  sibilant.macros.namespaces.core.chain = (function chain$(object, calls) {
    ...
    return (function() {
      if (0 === calls.length) {
        ...
        return macros.expandQuote.call(this, "46927", {
          "46930": object,
          "46934": calls[0].contents
        });
      } else {
  ...
  sibilant.macros.namespaces.core.chainable = (function chainable$(names) {
    ...
    return names.forEach((function(name) {
      ...
      return macros.expandQuote.call(this, "47264", { "47267": name });
    }));
  });
  ...
  sibilant.macros.namespaces.core["includes__QUERY"] = (function includes__QUERY$(haystack, needle) {
    ...
    return macros.expandQuote.call(this, "47459", {
      "47462": haystack,
      "47469": needle
    });
  });
  sibilant.macros.namespaces.core["excludes__QUERY"] = (function excludes__QUERY$(haystack, needle) {
    ...
    return macros.expandQuote.call(this, "47551", {
      "47554": haystack,
      "47561": needle
    });
  });
  sibilant.macros.namespaces.core["exists__QUERY"] = (function exists__QUERY$(thing) {
    ...
    return macros.expandQuote.call(this, "47616", {
      "47622": thing,
      "47629": thing
    });
  });
  ...
  sibilant.macros.namespaces.core.join = (function join$(arr, glue) {
    ...
    return macros.expandQuote.call(this, "47903", {
      "47907": arr,
      "47910": (glue || "\"\"")
    });
  });
      ...
      return (function() {
        ...
        case "bracket":
          ...
          lhs.contents.forEach((function(item, index) {
            ...
            return destructured.push([ transpile(item), macros.expandQuote.call(this, "48385", {
              "48388": symbol,
              "48391": index
            }) ]);
          }));
        ...
        case "brace":
          ...
          lhs.contents.forEach((function(item, index) {
            ...
            return destructured.push([ trItem, macros.expandQuote.call(this, "48718", {
              "48721": symbol,
              "48724": [ "\"", trItem, "\"" ]
            }) ]);
          }));
  ...
  sibilant.macros.namespaces.core.default = (function default$(pairs) {
    ...
    return interleave("\n", bulkMap(pairs, (function(name, value) {
      ...
      return macros.expandQuote.call(this, "49161", {
        "49164": name,
        "49173": name,
        "49177": name,
        "49180": value
  ...
  sibilant.macros.namespaces.core.namespace = (function namespace$(namespace) {
    ...
    macros.expandQuote.call(this, "49308", { "49311": namespace });
  ...
  sibilant.macros.namespaces.core["hasKey__QUERY"] = (function hasKey__QUERY$(object, key) {
    ...
    return macros.expandQuote.call(this, "49406", {
      "49410": object,
      "49413": key
    });
  });
  ...
  sibilant.macros.namespaces.core.set = (function set$(arr, kvPairs) {
    ...
    return interleave("\n", bulkMap(kvPairs, (function(k, v) {
      ...
      return macros.expandQuote.call(this, "50033", {
        "50039": arr,
        "50042": k,
        "50046": v
      });
  ...
  sibilant.macros.namespaces.core["lowerCase__QUERY"] = (function lowerCase__QUERY$(str) {
    ...
    return macros.expandQuote.call(this, "50092", {
      "50099": str,
      "50103": str
    });
  });
  sibilant.macros.namespaces.core["upperCase__QUERY"] = (function upperCase__QUERY$(str) {
    ...
    return macros.expandQuote.call(this, "50148", {
      "50155": str,
      "50159": str
    });
  });

...
(function(root) {
  ...
  var error = (function error$(str) {
    /* error /Users/jbr/code/sibilant/src/browser.sibilant:5:3 */

    throw new Error (str)
  });
  var inspect = (function inspect$(item) {
    /* inspect /Users/jbr/code/sibilant/src/browser.sibilant:6:3 */
  ...
  parser.parse = (function parser$parse$(string, context) {
    ...
    (function() {
      ...
      while (match) {
        __returnValue__ = (function() {
          /* /Users/jbr/code/sibilant/src/parser.sibilant:58:6 */
  ...
  var indent = (function indent$(args) {
    /* indent /Users/jbr/code/sibilant/src/sibilant.sibilant:12:1 */
  ...
  var ast = (function ast$(input, parent) {
    /* ast /Users/jbr/code/sibilant/src/sibilant.sibilant:21:1 */
    ...
    return (function() {
      if ((typeof node !== 'undefined')) {
        ...
        (node.modifiers || []).forEach((function(modifier) {
          /* /Users/jbr/code/sibilant/src/transpiler.sibilant:16:12 */
          ...
          return transpiler = (function(node) {
            /* /Users/jbr/code/sibilant/src/transpiler.sibilant:19:18 */
  ...
  readerMacros.hat = (function readerMacros$hat$(node, transpiler) {
    /* reader-macros.hat /Users/jbr/code/sibilant/src/transpiler.sibilant:27:1 */

    return ("macros." + transpiler(node));
  });
  readerMacros.tick = (function readerMacros$tick$(node, transpiler) {
    /* reader-macros.tick /Users/jbr/code/sibilant/src/transpiler.sibilant:28:1 */
  ...
  readerMacros.dots = (function readerMacros$dots$(node, transpiler) {
    /* reader-macros.dots /Users/jbr/code/sibilant/src/transpiler.sibilant:30:1 */
  ...
  transpile.number = (function transpile$number$(node) {
    /* transpile.number /Users/jbr/code/sibilant/src/transpiler.sibilant:36:1 */

    return parseFloat(node.token.replace((new RegExp(",", "g")), ""));
  });
  transpile.root = (function transpile$root$(node) {
    /* transpile.root /Users/jbr/code/sibilant/src/transpiler.sibilant:39:1 */
  ...
  transpile.expression = (function transpile$expression$(node, preprocessor) {
    /* transpile.expression /Users/jbr/code/sibilant/src/transpiler.sibilant:44:1 */
  ...
  transpile.bracket = (function transpile$bracket$(node) {
    /* transpile.bracket /Users/jbr/code/sibilant/src/transpiler.sibilant:63:1 */

    return macros.list.apply(undefined, node.contents);
  });
  transpile.brace = (function transpile$brace$(node) {
    /* transpile.brace /Users/jbr/code/sibilant/src/transpiler.sibilant:64:1 */

    return macros.hash.apply(undefined, node.contents);
  });
  transpile.literal = (function transpile$literal$(node) {
    /* transpile.literal /Users/jbr/code/sibilant/src/transpiler.sibilant:66:1 */
    ...
    , string.match((new RegExp("-(.)", "g"))), (function(returnString, match) {
      /* /Users/jbr/code/sibilant/src/transpiler.sibilant:68:6 */

      return returnString.replace(match, (match)[1].toUpperCase());
    }));
  });
  transpile.string = (function transpile$string$(node) {
    /* transpile.string /Users/jbr/code/sibilant/src/transpiler.sibilant:77:1 */
  ...
  sibilant.initialize = (function sibilant$initialize$() {
    /* sibilant.initialize /Users/jbr/code/sibilant/src/sibilant.sibilant:26:1 */
  ...
  var sibilize = (function sibilize$(input) {
    /* sibilize /Users/jbr/code/sibilant/src/sibilant.sibilant:31:1 */
  ...
  sibilant.version = (function sibilant$version$() {
    /* sibilant.version /Users/jbr/code/sibilant/src/sibilant.sibilant:37:1 */

    return (sibilant.packageInfo())["version"];
  });
  sibilant.packageInfo = (function sibilant$packageInfo$() {
    /* sibilant.package-info /Users/jbr/code/sibilant/src/sibilant.sibilant:40:1 */

    var fs = require("fs");
    return JSON.parse(fs.readFileSync((__dirname + "/../package.json")));
  });
  sibilant.versionString = (function sibilant$versionString$() {
    /* sibilant.version-string /Users/jbr/code/sibilant/src/sibilant.sibilant:45:1 */
  ...
  sibilant.stripShebang = (function sibilant$stripShebang$(data) {
    /* sibilant.strip-shebang /Users/jbr/code/sibilant/src/sibilant.sibilant:51:1 */
  ...
  (require.extensions)[".sibilant"] = (function(module, filename) {
    /* /Users/jbr/code/sibilant/src/sibilant.sibilant:58:1 */

    var content = sibilant.sibilizeFile(filename);
    return module._compile(content, filename);
  });
  (require.extensions)[".son"] = (function(module, filename) {
    /* /Users/jbr/code/sibilant/src/sibilant.sibilant:63:1 */
  ...
  sibilant.include = (function sibilant$include$(file) {
    /* sibilant.include /Users/jbr/code/sibilant/src/sibilant.sibilant:69:1 */
  ...
  var withDirAndFile = (function withDirAndFile$(dir, file, fn) {
    /* with-dir-and-file /Users/jbr/code/sibilant/src/sibilant.sibilant:82:1 */
  ...
  sibilant.sibilizeFile = (function sibilant$sibilizeFile$(fileName) {
    /* sibilant.sibilize-file /Users/jbr/code/sibilant/src/sibilant.sibilant:97:1 */

    return withDirAndFile(path.dirname(fileName), fileName, (function() {
      /* /Users/jbr/code/sibilant/src/sibilant.sibilant:99:25 */
  ...
  sibilant.sibilizeJson = (function sibilant$sibilizeJson$(fileName) {
    /* sibilant.sibilize-json /Users/jbr/code/sibilant/src/sibilant.sibilant:104:1 */
  ...
  sibilant.macros.include = (function sibilant$macros$include$(file) {
    /* sibilant.macros.include /Users/jbr/code/sibilant/src/sibilant.sibilant:112:1 */
  ...
  return (function() {
    if ((typeof $ !== 'undefined')) {
      return $((function() {
        /* /Users/jbr/code/sibilant/src/browser.sibilant:11:8 */

        var sibilant = root.sibilant,
            scripts = [];
        var evalCode = (function evalCode$(js) {
          /* eval-code /Users/jbr/code/sibilant/src/browser.sibilant:15:9 */

          return (new Function(js))();
        });
        sibilant.scriptLoaded = (function sibilant$scriptLoaded$() {
          /* sibilant.script-loaded /Users/jbr/code/sibilant/src/browser.sibilant:18:9 */

          var lisp = null,
              js = null;
          return (function() {
            if ((!sibilant.loadNextScript())) {
              return $("script[type=\"text/sibilant\"]:not([src])", undefined.forEach((function(#>, lisp = $(this, text(), replace(/(^\s*\/\/\<!\[CDATA\[)|(\/\/\]\]>\s*$)/g, ""));
        ...
        sibilant.loadNextScript = (function sibilant$loadNextScript$() {
          /* sibilant.load-next-script /Users/jbr/code/sibilant/src/browser.sibilant:36:11 */

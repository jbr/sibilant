...
(function(root) {
  ...
  sibilant.macros.namespaces.core.def = (function sibilant$macros$namespaces$core$def$(fnName, args, body) {
    ...
    var fnNameTr = transpile(fnName),
        thisNode = this;
    sibilant.docs.record(("function " + fnNameTr), this);
  ...
  sibilant.macros.namespaces.core.macro = (function sibilant$macros$namespaces$core$macro$(name, args, body) {
    ...
    sibilant.docs.record(("macro " + sibilant.macros.searchPath[0] + "/" + nameTr), this);
    (function() {
      try {
  ...
  sibilant.macros.namespaces.core.docs = (function sibilant$macros$namespaces$core$docs$(options) {
    ...
    (function() {
      if ((1 === (options.length % 2))) {
        return (function() {
          if (node__QUERY(options[0], "string")) {
            return optionsString = options.shift();
          } else if (node__QUERY(options.slice(-1)[0], "string")) {
    ...
    (function() {
      if ((optionsHash.hasOwnProperty("examples") && node__QUERY(optionsHash.examples, "bracket"))) {
        return optionsHash.examples = optionsHash.examples.contents;
      }
    })();
    (function() {
  ...
  sibilant.packageInfo = (function sibilant$packageInfo$() {
    /* sibilant.package-info /Users/jbr/code/sibilant/src/browser.sibilant:24:3 */
  
    return package;
  });
  sibilant.versionString = (function sibilant$versionString$() {
    /* sibilant.version-string /Users/jbr/code/sibilant/src/browser.sibilant:26:3 */
  ...
  return (function() {
    if ((typeof $ !== "undefined")) {
      return $((function() {
        /* /Users/jbr/code/sibilant/src/browser.sibilant:32:12 */
      
        var sibilant = root.sibilant,
            scripts = $.makeArray($("script[type=\"application/sibilant\"][src]").map((function() {
          /* /Users/jbr/code/sibilant/src/browser.sibilant:35:48 */
        
          return this.src;
        })));
        sibilant.initialize = (function sibilant$initialize$() {
          /* sibilant.initialize /Users/jbr/code/sibilant/src/browser.sibilant:37:13 */
        
          return false;
        });
        var evalCode = (function evalCode$(js) {
          /* eval-code /Users/jbr/code/sibilant/src/browser.sibilant:40:13 */
        
          return (new Function(js))();
        });
        sibilant.include = (function sibilant$include$(url) {
          /* sibilant.include /Users/jbr/code/sibilant/src/browser.sibilant:43:13 */
        
          return $.get(url).done((function() {
            /* /Users/jbr/code/sibilant/src/browser.sibilant:44:35 */
          
            return evalCode(sibilize(arguments[0]));
          }));
        });
        sibilant.loadMacros = (function sibilant$loadMacros$(fn) {
          /* sibilant.load-macros /Users/jbr/code/sibilant/src/browser.sibilant:46:13 */
        
          return sibilant.include("/javascripts/macros.sibilant").done((function() {
            /* /Users/jbr/code/sibilant/src/browser.sibilant:48:31 */

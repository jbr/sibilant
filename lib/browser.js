...
(function(root) {
    ...
    return docs.definitions.map((function(definition) {
      ...
      return {
        ...
        examples: (definition.examples || []).map((function() {
          /* /Users/jbr/code/sibilant/src/docs.sibilant:50:74 */
  ...
  sibilant.macros.namespaces.core.apply = (function apply$(fn, arglist) {
    ...
    return macros.expandQuote.call(this, "40729", {
      "40733": fn,
      "40738": arglist
    });
  });
  ...
  sibilant.macros.namespaces.core.append = (function append$(list, additional) {
    ...
    return macros.expandQuote.call(this, "40869", {
      "40873": list,
      "40880": additional
    });
  });
  sibilant.macros.namespaces.core.length = (function length$(arr) {
    ...
    return macros.expandQuote.call(this, "40933", { "40936": arr });
  });
  sibilant.macros.namespaces.core.scoped = (function scoped$(body) {
    ...
    return macros.expandQuote.call(this, "41006", {
      "41013": {
        node: this,
        args: []
      },
  ...
  sibilant.macros.namespaces.core["_scopedWithoutSource"] = (function _scopedWithoutSource$(body) {
    ...
    return [ "(function() {", indent(macros.expandQuote.call(this, "41061", { "41065": body })), "}).call(this)" ];
  });
  sibilant.macros.namespaces.core["_numberWords"] = (function _numberWords$(numberWords) {
    ...
    return numberWords.forEach((function(word, index) {
      ...
      macros.expandQuote.call(this, "41140", {
        "41143": ("fetches the " + outputFormatter(transpile(word)) + " element from `arr`"),
        "41201": word
      });
      return macros.expandQuote.call(this, "41242", {
        "41245": word,
        "41257": index
      });
    }));
  ...
  sibilant.macros.namespaces.core["_defInfix"] = (function _defInfix$(macroName, word, jsComparator) {
    ...
    macros.expandQuote.call(this, "42151", {
      "42154": docstring,
      "42162": macroName,
      "42173": macroName
    });
    return macros.expandQuote.call(this, "42200", {
      "42203": macroName,
      "42231": (jsComparator || [ "\"", macroName, "\"" ])
    });
  });
  sibilant.macros.namespaces.core[">"] = (function $$(args) {
  ...
  sibilant.macros.namespaces.core.new = (function new$(constructor, args) {
    ...
    return [ "(new ", macros.expandQuote.call(this, "42683", {
      "42686": constructor,
      "42690": args
    }), ")" ];
  });
  sibilant.macros.namespaces.core.regex = (function regex$(pattern, flags) {
    ...
    return macros.expandQuote.call(this, "42752", {
      "42757": pattern,
      "42760": (flags || "undefined")
    });
  });
  ...
  sibilant.macros.namespaces.core["zero__QUERY"] = (function zero__QUERY$(item) {
    ...
    return macros.expandQuote.call(this, "42860", { "42863": item });
  });
  sibilant.macros.namespaces.core["empty__QUERY"] = (function empty__QUERY$(arr) {
    ...
    return macros.expandQuote.call(this, "42911", { "42919": arr });
  });
  sibilant.macros.namespaces.core["odd__QUERY"] = (function odd__QUERY$(number) {
    ...
    return macros.expandQuote.call(this, "42964", { "42972": number });
  });
  sibilant.macros.namespaces.core["even__QUERY"] = (function even__QUERY$(number) {
    ...
    return macros.expandQuote.call(this, "43019", { "43027": number });
  });
  ...
  sibilant.macros.namespaces.core["string__QUERY"] = (function string__QUERY$(things) {
    ...
    return macros.expandQuote.call(this, "43136", { "43140": map(things, (function(thing) {
      /* /Users/jbr/code/sibilant/include/macros.sibilant:282:29 */
    
      return macros.expandQuote.call(this, "43153", { "43159": thing });
    })) });
  });
  sibilant.macros.namespaces.core["function__QUERY"] = (function function__QUERY$(things) {
    ...
    return macros.expandQuote.call(this, "43224", { "43228": map(things, (function(thing) {
      /* /Users/jbr/code/sibilant/include/macros.sibilant:288:29 */
    
      return macros.expandQuote.call(this, "43241", { "43247": thing });
    })) });
  });
  sibilant.macros.namespaces.core["undefined__QUERY"] = (function undefined__QUERY$(things) {
    ...
    return macros.expandQuote.call(this, "43332", { "43336": map(things, (function(thing) {
      /* /Users/jbr/code/sibilant/include/macros.sibilant:297:29 */
    
      return macros.expandQuote.call(this, "43349", { "43355": thing });
    })) });
  });
  sibilant.macros.namespaces.core["defined__QUERY"] = (function defined__QUERY$(things) {
    ...
    return macros.expandQuote.call(this, "43440", { "43444": map(things, (function(thing) {
      /* /Users/jbr/code/sibilant/include/macros.sibilant:305:29 */
    
      return macros.expandQuote.call(this, "43457", { "43463": thing });
    })) });
  });
  sibilant.macros.namespaces.core["number__QUERY"] = (function number__QUERY$(things) {
    ...
    return macros.expandQuote.call(this, "43530", { "43534": map(things, (function(thing) {
      /* /Users/jbr/code/sibilant/include/macros.sibilant:312:29 */
    
      return macros.expandQuote.call(this, "43547", { "43553": thing });
    })) });
  });
  sibilant.macros.namespaces.core.if = (function if$(arg, truebody, falsebody) {
    ...
    return [ "(function() {", indent([ "if (", transpile(arg), ") {", indent(macros.expandQuote.call(this, "43642", { "43646": truebody })), "} else {", indent(macros.expandQuote.call(this, "43705", { "43709": falsebody })), "}" ]), "}).call(this)" ];
  });
          ...
          return (function() {
            ...
            var cloned = (function() {
              if (node__QUERY(item, "literal", "dots")) {
                return macros.expandQuote.call(this, "44275", { "44276": item }).source;
              } else {
                return clone(item);
              }
            }).call(this);
  ...
  sibilant.macros.namespaces.core.when = (function when$(condition, body) {
    ...
    return [ "(function() {", indent([ "if (", transpile(condition), ") {", indent(macros.expandQuote.call(this, "45131", { "45135": body })), "}" ]), "}).call(this)" ];
  });
  ...
  sibilant.macros.namespaces.core.unless = (function unless$(condition, body) {
    ...
    return [ "(function() {", indent([ "if (", macros.expandQuote.call(this, "45358", { "45361": condition }), ") {", indent(macros.expandQuote.call(this, "45395", { "45399": body })), "}" ]), "}).call(this)" ];
  });
  ...
  sibilant.macros.namespaces.core.logPretty = (function logPretty$(label, arg) {
    ...
    return macros.expandQuote.call(this, "45809", {
      "45815": [ "\"", node.file, ":", node.line, "\"" ],
      "45830": label,
      "45838": arg
    });
  });
  sibilant.macros.namespaces.core.each = (function each$(item, array, body) {
    ...
    return macros.expandQuote.call(this, "46056", {
      "46060": array,
      "46085": {
        node: this,
        args: (function() {
  ...
  sibilant.macros.namespaces.core.try = (function try$(tryblock, catchblock) {
    ...
    return [ "(function() {", indent([ "try {", indent(macros.expandQuote.call(this, "46456", { "46459": tryblock })), "} catch (e) {", indent(macros.expandQuote.call(this, "46504", { "46507": catchblock })), "}" ]), "}).call(this)" ];
  });
  ...
  sibilant.macros.namespaces.core.while = (function while$(condition, body) {
    ...
    return macros.expandQuote.call(this, "46879", {
      "46894": symbol,
      "46907": [ "while (", transpile(condition), ") {", indent(macros.expandQuote.call(this, "46934", {
        "46937": symbol,
        "46944": body
      })), "}" ],
      "46974": symbol
  ...
  sibilant.macros.namespaces.core.until = (function until$(condition, body) {
    ...
    return macros.expandQuote.call(this, "47043", {
      "47049": condition,
      "47054": body
    });
  });
  sibilant.macros.namespaces.core["match__QUERY"] = (function match__QUERY$(regexp, string) {
    ...
    return macros.expandQuote.call(this, "47113", {
      "47117": string,
      "47120": regexp
    });
  });
  sibilant.macros.namespaces.core["matchRegex__QUERY"] = (function matchRegex__QUERY$(string, pattern, flags) {
    ...
    return macros.expandQuote.call(this, "47173", {
      "47179": pattern,
      "47182": flags,
      "47186": string
    });
  ...
  sibilant.macros.namespaces.core.replace = (function replace$(string, pattern, replacement) {
    ...
    return macros.expandQuote.call(this, "47239", {
      "47243": string,
      "47263": pattern,
      "47281": replacement
    });
  ...
  sibilant.macros.namespaces.core.replaceAll = (function replaceAll$(string, pattern, replacement) {
    ...
    return macros.expandQuote.call(this, "47333", {
      "47337": string,
      "47343": pattern,
      "47350": replacement
    });
  ...
  sibilant.macros.namespaces.core.thunk = (function thunk$(body) {
    ...
    return macros.expandQuote.call(this, "47460", {
      "47463": {
        node: this,
        args: []
      },
      "47485": mapNode(body, (function(node) {
        /* /Users/jbr/code/sibilant/include/macros.sibilant:608:17 */
      
        return (function() {
          if (node__QUERY(node, "argPlaceholder")) {
            return macros.expandQuote.call(this, "47569", { "47572": node.token.replace((new RegExp("^#", undefined)), "") });
          } else {
            return node;
          }
        }).call(this);
  ...
  sibilant.macros.namespaces.core.argument = (function argument$(index) {
    ...
    return macros.expandQuote.call(this, "48181", { "48186": index });
  });
  sibilant.macros.namespaces.core.eachKey = (function eachKey$(as, obj, body) {
    ...
    return macros.expandQuote.call(this, "48255", {
      "48258": obj,
      "48286": {
        args: (function() {
  ...
  sibilant.macros.namespaces.core.switch = (function switch$(obj, cases) {
    ...
    return [ "(function() {", indent([ "switch(", transpile(obj), ") {", map(cases, (function(caseDef) {
      ...
      return [ "\n", caseString, indent(macros.expandQuote.call(this, "49354", { "49358": caseDef.contents.slice(1) })) ];
    })), "}" ]), "}).call(this)" ];
  });
    ...
    return [ "(function() {", indent(interleave(" else ", bulkMap(alternatingConditionsAndBranches, (function(cond, val) {
      ...
      return (function() {
        if (typeof val !== "undefined") {
          return [ "if (", transpile(cond), ") {", indent(macros.expandQuote.call(this, "49979", { "49982": val })), "}" ];
        } else {
          return [ "{", indent(macros.expandQuote.call(this, "50065", { "50068": cond })), "}" ];
        }
      }).call(this);
    })))), "}).call(this)" ];
  });
  sibilant.macros.namespaces.core.chain = (function chain$(object, calls) {
    ...
    return (function() {
      if (0 === calls.length) {
        ...
        return macros.expandQuote.call(this, "50207", {
          "50210": object,
          "50214": calls[0].contents
        });
      } else {
  ...
  sibilant.macros.namespaces.core.chainable = (function chainable$(names) {
    ...
    return names.forEach((function(name) {
      ...
      return macros.expandQuote.call(this, "50544", { "50547": name });
    }));
  });
  ...
  sibilant.macros.namespaces.core["includes__QUERY"] = (function includes__QUERY$(haystack, needle) {
    ...
    return macros.expandQuote.call(this, "50739", {
      "50742": haystack,
      "50749": needle
    });
  });
  sibilant.macros.namespaces.core["excludes__QUERY"] = (function excludes__QUERY$(haystack, needle) {
    ...
    return macros.expandQuote.call(this, "50831", {
      "50834": haystack,
      "50841": needle
    });
  });
  sibilant.macros.namespaces.core["exists__QUERY"] = (function exists__QUERY$(thing) {
    ...
    return macros.expandQuote.call(this, "50896", {
      "50902": thing,
      "50909": thing
    });
  });
  ...
  sibilant.macros.namespaces.core.join = (function join$(arr, glue) {
    ...
    return macros.expandQuote.call(this, "51183", {
      "51187": arr,
      "51190": (glue || "\"\"")
    });
  });
      ...
      return (function() {
        ...
        case "bracket":
          ...
          lhs.contents.forEach((function(item, index) {
            ...
            return destructured.push([ transpile(item), macros.expandQuote.call(this, "51665", {
              "51668": symbol,
              "51671": index
            }) ]);
          }));
        ...
        case "brace":
          ...
          lhs.contents.forEach((function(item, index) {
            ...
            return destructured.push([ trItem, macros.expandQuote.call(this, "51998", {
              "52001": symbol,
              "52004": [ "\"", trItem, "\"" ]
            }) ]);
          }));
  ...
  sibilant.macros.namespaces.core.default = (function default$(pairs) {
    ...
    return interleave("\n", bulkMap(pairs, (function(name, value) {
      ...
      return macros.expandQuote.call(this, "52441", {
        "52444": name,
        "52453": name,
        "52457": name,
        "52460": value
  ...
  sibilant.macros.namespaces.core.namespace = (function namespace$(namespace) {
    ...
    macros.expandQuote.call(this, "52588", { "52591": namespace });
  ...
  sibilant.macros.namespaces.core["hasKey__QUERY"] = (function hasKey__QUERY$(object, key) {
    ...
    return macros.expandQuote.call(this, "52686", {
      "52690": object,
      "52693": key
    });
  });
  ...
  sibilant.macros.namespaces.core.set = (function set$(arr, kvPairs) {
    ...
    return interleave("\n", bulkMap(kvPairs, (function(k, v) {
      ...
      return macros.expandQuote.call(this, "53313", {
        "53319": arr,
        "53322": k,
        "53326": v
      });
  ...
  sibilant.macros.namespaces.core["lowerCase__QUERY"] = (function lowerCase__QUERY$(str) {
    ...
    return macros.expandQuote.call(this, "53372", {
      "53379": str,
      "53383": str
    });
  });
  sibilant.macros.namespaces.core["upperCase__QUERY"] = (function upperCase__QUERY$(str) {
    ...
    return macros.expandQuote.call(this, "53428", {
      "53435": str,
      "53439": str
    });
  });

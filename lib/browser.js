...
(function(root) {
  ...
  var log__BANG = (function log__BANG$(args) {
    ...
    return inspect__BANG.apply(this, args).forEach((function(o) {
  ...
  (parser)["orderedRegexes"] = parser.tokenPrecedence.map((function(x) {
    /* /Users/jbr/code/sibilant/src/parser.sibilant:39:23 */
  ...
  var cacheNode = (function cacheNode$(node) {
    /* cache-node /Users/jbr/code/sibilant/src/parser.sibilant:50:0 */
  ...
  parser.parse = (function parser$parse$(string, context) {
    /* parser.parse /Users/jbr/code/sibilant/src/parser.sibilant:57:1 */
  ...
  macros.quotedHash = (function macros$quotedHash$(pairs) {
    /* ^quoted-hash /Users/jbr/code/sibilant/src/macros.sibilant:151:0 */
  ...
  var logPretty = (function logPretty$(label, arg) {
    /* log-pretty /Users/jbr/code/sibilant/src/macros.sibilant:182:0 */
  ...
  macros.quote = (function macros$quote$(content) {
    /* ^quote /Users/jbr/code/sibilant/src/macros.sibilant:188:0 */
  ...
  macros.debug = (function macros$debug$(val) {
    /* ^debug /Users/jbr/code/sibilant/src/macros.sibilant:201:0 */
  
    (sibilant)["debug"] = eval(outputFormatter(transpile(val)));
    return null;
  });
  var mapNode = (function mapNode$(node, fn) {
    /* map-node /Users/jbr/code/sibilant/src/macros.sibilant:204:0 */
    ...
    return (function() {
      if (node__QUERY(node)) {
        ...
        return map(node, (function(c) {
          /* /Users/jbr/code/sibilant/src/macros.sibilant:213:32 */
  ...
  var eachNode = (function eachNode$(node, fn) {
    /* each-node /Users/jbr/code/sibilant/src/macros.sibilant:216:0 */
    ...
    return (function() {
      if (node__QUERY(node)) {
        ...
        return node.forEach((function(c) {
          /* /Users/jbr/code/sibilant/src/macros.sibilant:218:22 */
  ...
  var mapNodeForQuoteExpansion = (function mapNodeForQuoteExpansion$(node, expansions) {
    /* map-node-for-quote-expansion /Users/jbr/code/sibilant/src/macros.sibilant:222:0 */
    ...
    return (function() {
      if (node__QUERY(node)) {
        ...
        return map(node, (function(c) {
          /* /Users/jbr/code/sibilant/src/macros.sibilant:233:21 */
        
          return mapNodeForQuoteExpansion(c, expansions);
        }));
      } else {
        return node;
      }
  ...
  macros.expandQuote = (function macros$expandQuote$(nodeId, expansions) {
    /* ^expand-quote /Users/jbr/code/sibilant/src/macros.sibilant:238:0 */
  ...
  var unquote__QUERY = (function unquote__QUERY$(node) {
    /* unquote? /Users/jbr/code/sibilant/src/macros.sibilant:244:0 */
  
    return node__QUERY(node, "at");
  });
  var findUnquotes = (function findUnquotes$(node) {
    /* find-unquotes /Users/jbr/code/sibilant/src/macros.sibilant:246:0 */
  
    var unquotes = {  };
    eachNode(node, (function(n) {
      /* /Users/jbr/code/sibilant/src/macros.sibilant:248:21 */
  ...
  var spliceDots = (function spliceDots$(node) {
    /* splice-dots /Users/jbr/code/sibilant/src/macros.sibilant:254:0 */
  
    (function() {
      if (((node.contents) && typeof (node.contents) === "object" && (node.contents).constructor.name === "Array")) {
        var contents = [];
        node.contents.forEach((function(content) {
          /* /Users/jbr/code/sibilant/src/macros.sibilant:257:11 */
  ...
  var alternatingKeysAndValues = (function alternatingKeysAndValues$(hash) {
    /* alternating-keys-and-values /Users/jbr/code/sibilant/src/macros.sibilant:269:0 */
  
    return flatten(map(Object.keys(hash), (function(key) {
      /* /Users/jbr/code/sibilant/src/macros.sibilant:271:19 */
    
      return [ key, (hash)[key] ];
    })));
  });
  macros.list = (function macros$list$(args) {
    /* ^list /Users/jbr/code/sibilant/src/macros.sibilant:274:0 */
    ...
    return (function() {
      if (((args).length === 0)) {
        ...
        var simpleList = (function simpleList$(args) {
          /* simple-list /Users/jbr/code/sibilant/src/macros.sibilant:278:12 */
        
          return [ "[ ", interleave(", ", map(args, (function(arg) {
            /* /Users/jbr/code/sibilant/src/macros.sibilant:279:50 */
          
            return arg.transpiled;
          }))), " ]" ];
        });
        args.forEach((function(arg) {
          /* /Users/jbr/code/sibilant/src/macros.sibilant:281:27 */
        ...
        argSegments = map(argSegments, (function(segment) {
          /* /Users/jbr/code/sibilant/src/macros.sibilant:287:38 */
  ...
  macros.call = (function macros$call$(fnName, args) {
    /* ^call /Users/jbr/code/sibilant/src/macros.sibilant:297:0 */
  
    var args = Array.prototype.slice.call(arguments, 1);
  
    return (function() {
      if (any__QUERY(args, (function(arg) {
        /* /Users/jbr/code/sibilant/src/macros.sibilant:298:20 */
  ...
  macros.dots = (function macros$dots$(contents) {
    /* ^dots /Users/jbr/code/sibilant/src/macros.sibilant:303:0 */

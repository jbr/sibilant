...
(function(root) {
    ...
    return docs.definitions.map((function(definition) {
      ...
      return {
        ...
        examples: definition.examples.map((function() {
          /* /Users/jbr/code/sibilant/src/docs.sibilant:50:61 */
  ...
  sibilant.macros.namespaces.core.apply = (function apply$(fn, arglist) {
    ...
    return macros.expandQuote.call(this, "40593", {
      "40597": fn,
      "40602": arglist
    });
  });
  ...
  sibilant.macros.namespaces.core.append = (function append$(list, additional) {
    ...
    return macros.expandQuote.call(this, "40733", {
      "40737": list,
      "40744": additional
    });
  });
  sibilant.macros.namespaces.core.length = (function length$(arr) {
    ...
    return macros.expandQuote.call(this, "40797", { "40800": arr });
  });
  sibilant.macros.namespaces.core.scoped = (function scoped$(body) {
    ...
    return macros.expandQuote.call(this, "40870", {
      "40877": {
        node: this,
        args: []
      },
  ...
  sibilant.macros.namespaces.core["_scopedWithoutSource"] = (function _scopedWithoutSource$(body) {
    ...
    return [ "(function() {", indent(macros.expandQuote.call(this, "40925", { "40929": body })), "}).call(this)" ];
  });
  sibilant.macros.namespaces.core["_numberWords"] = (function _numberWords$(numberWords) {
    ...
    return numberWords.forEach((function(word, index) {
      ...
      macros.expandQuote.call(this, "41004", {
        "41007": ("fetches the " + outputFormatter(transpile(word)) + " element from `arr`"),
        "41065": word
      });
      return macros.expandQuote.call(this, "41106", {
        "41109": word,
        "41121": index
      });
    }));
  ...
  sibilant.macros.namespaces.core["_defInfix"] = (function _defInfix$(macroName, word, jsComparator) {
    ...
    macros.expandQuote.call(this, "42015", {
      "42018": docstring,
      "42026": macroName,
      "42037": macroName
    });
    return macros.expandQuote.call(this, "42064", {
      "42067": macroName,
      "42095": (jsComparator || [ "\"", macroName, "\"" ])
    });
  });
  sibilant.macros.namespaces.core[">"] = (function $$(args) {
    /* > /Users/jbr/code/sibilant-clean/include/macros.sibilant:186:8 */
  
    var args = Array.prototype.slice.call(arguments, 0);
  
    var jsComparator = ">";
    return macros.expandQuote.call(this, "2432", { "2436": map(args.slice(0, -1), (function(item, index) {
      /* /Users/jbr/code/sibilant-clean/include/macros.sibilant:189:30 */
  ...
  sibilant.macros.namespaces.core.new = (function new$(constructor, args) {
    ...
    return [ "(new ", macros.expandQuote.call(this, "42547", {
      "42550": constructor,
      "42554": args
    }), ")" ];
  });
  sibilant.macros.namespaces.core.regex = (function regex$(pattern, flags) {
    ...
    return macros.expandQuote.call(this, "42616", {
      "42621": pattern,
      "42624": (flags || "undefined")
    });
  });
  ...
  sibilant.macros.namespaces.core["zero__QUERY"] = (function zero__QUERY$(item) {
    ...
    return macros.expandQuote.call(this, "42724", { "42727": item });
  });
  sibilant.macros.namespaces.core["empty__QUERY"] = (function empty__QUERY$(arr) {
    ...
    return macros.expandQuote.call(this, "42775", { "42783": arr });
  });
  sibilant.macros.namespaces.core["odd__QUERY"] = (function odd__QUERY$(number) {
    ...
    return macros.expandQuote.call(this, "42828", { "42836": number });
  });
  sibilant.macros.namespaces.core["even__QUERY"] = (function even__QUERY$(number) {
    ...
    return macros.expandQuote.call(this, "42883", { "42891": number });
  });
  ...
  sibilant.macros.namespaces.core["string__QUERY"] = (function string__QUERY$(things) {
    ...
    return macros.expandQuote.call(this, "43000", { "43004": map(things, (function(thing) {
      /* /Users/jbr/code/sibilant/include/macros.sibilant:282:29 */
    
      return macros.expandQuote.call(this, "43017", { "43023": thing });
    })) });
  });
  sibilant.macros.namespaces.core["function__QUERY"] = (function function__QUERY$(things) {
    ...
    return macros.expandQuote.call(this, "43088", { "43092": map(things, (function(thing) {
      /* /Users/jbr/code/sibilant/include/macros.sibilant:288:29 */
    
      return macros.expandQuote.call(this, "43105", { "43111": thing });
    })) });
  });
  sibilant.macros.namespaces.core["undefined__QUERY"] = (function undefined__QUERY$(things) {
    ...
    return macros.expandQuote.call(this, "43196", { "43200": map(things, (function(thing) {
      /* /Users/jbr/code/sibilant/include/macros.sibilant:297:29 */
    
      return macros.expandQuote.call(this, "43213", { "43219": thing });
    })) });
  });
  sibilant.macros.namespaces.core["defined__QUERY"] = (function defined__QUERY$(things) {
    ...
    return macros.expandQuote.call(this, "43304", { "43308": map(things, (function(thing) {
      /* /Users/jbr/code/sibilant/include/macros.sibilant:305:29 */
    
      return macros.expandQuote.call(this, "43321", { "43327": thing });
    })) });
  });
  sibilant.macros.namespaces.core["number__QUERY"] = (function number__QUERY$(things) {
    ...
    return macros.expandQuote.call(this, "43394", { "43398": map(things, (function(thing) {
      /* /Users/jbr/code/sibilant/include/macros.sibilant:312:29 */
    
      return macros.expandQuote.call(this, "43411", { "43417": thing });
    })) });
  });
  sibilant.macros.namespaces.core.if = (function if$(arg, truebody, falsebody) {
    ...
    return [ "(function() {", indent([ "if (", transpile(arg), ") {", indent(macros.expandQuote.call(this, "43506", { "43510": truebody })), "} else {", indent(macros.expandQuote.call(this, "43569", { "43573": falsebody })), "}" ]), "}).call(this)" ];
  });
          ...
          return (function() {
            ...
            var cloned = (function() {
              if (node__QUERY(item, "literal", "dots")) {
                return macros.expandQuote.call(this, "44139", { "44140": item }).source;
              } else {
                return clone(item);
              }
            }).call(this);
  ...
  sibilant.macros.namespaces.core.when = (function when$(condition, body) {
    ...
    return [ "(function() {", indent([ "if (", transpile(condition), ") {", indent(macros.expandQuote.call(this, "44995", { "44999": body })), "}" ]), "}).call(this)" ];
  });
  ...
  sibilant.macros.namespaces.core.unless = (function unless$(condition, body) {
    ...
    return [ "(function() {", indent([ "if (", macros.expandQuote.call(this, "45222", { "45225": condition }), ") {", indent(macros.expandQuote.call(this, "45259", { "45263": body })), "}" ]), "}).call(this)" ];
  });
  ...
  sibilant.macros.namespaces.core.logPretty = (function logPretty$(label, arg) {
    ...
    return macros.expandQuote.call(this, "45673", {
      "45679": [ "\"", node.file, ":", node.line, "\"" ],
      "45694": label,
      "45702": arg
    });
  });
  sibilant.macros.namespaces.core.each = (function each$(item, array, body) {
    ...
    return macros.expandQuote.call(this, "45920", {
      "45924": array,
      "45949": {
        node: this,
        args: (function() {
  ...
  sibilant.macros.namespaces.core.try = (function try$(tryblock, catchblock) {
    ...
    return [ "(function() {", indent([ "try {", indent(macros.expandQuote.call(this, "46320", { "46323": tryblock })), "} catch (e) {", indent(macros.expandQuote.call(this, "46368", { "46371": catchblock })), "}" ]), "}).call(this)" ];
  });
  ...
  sibilant.macros.namespaces.core.while = (function while$(condition, body) {
    ...
    return macros.expandQuote.call(this, "46743", {
      "46758": symbol,
      "46771": [ "while (", transpile(condition), ") {", indent(macros.expandQuote.call(this, "46798", {
        "46801": symbol,
        "46808": body
      })), "}" ],
      "46838": symbol
  ...
  sibilant.macros.namespaces.core.until = (function until$(condition, body) {
    ...
    return macros.expandQuote.call(this, "46907", {
      "46913": condition,
      "46918": body
    });
  });
  sibilant.macros.namespaces.core["match__QUERY"] = (function match__QUERY$(regexp, string) {
    ...
    return macros.expandQuote.call(this, "46977", {
      "46981": string,
      "46984": regexp
    });
  });
  sibilant.macros.namespaces.core["matchRegex__QUERY"] = (function matchRegex__QUERY$(string, pattern, flags) {
    ...
    return macros.expandQuote.call(this, "47037", {
      "47043": pattern,
      "47046": flags,
      "47050": string
    });
  ...
  sibilant.macros.namespaces.core.replace = (function replace$(string, pattern, replacement) {
    ...
    return macros.expandQuote.call(this, "47103", {
      "47107": string,
      "47127": pattern,
      "47145": replacement
    });
  ...
  sibilant.macros.namespaces.core.replaceAll = (function replaceAll$(string, pattern, replacement) {
    ...
    return macros.expandQuote.call(this, "47197", {
      "47201": string,
      "47207": pattern,
      "47214": replacement
    });
  ...
  sibilant.macros.namespaces.core.thunk = (function thunk$(body) {
    ...
    return macros.expandQuote.call(this, "47324", {
      "47327": {
        node: this,
        args: []
      },
      "47349": mapNode(body, (function(node) {
        /* /Users/jbr/code/sibilant/include/macros.sibilant:608:17 */
      
        return (function() {
          if (node__QUERY(node, "argPlaceholder")) {
            return macros.expandQuote.call(this, "47433", { "47436": node.token.replace((new RegExp("^#", undefined)), "") });
          } else {
            return node;
          }
        }).call(this);
  ...
  sibilant.macros.namespaces.core.argument = (function argument$(index) {
    ...
    return macros.expandQuote.call(this, "48045", { "48050": index });
  });
  sibilant.macros.namespaces.core.eachKey = (function eachKey$(as, obj, body) {
    ...
    return macros.expandQuote.call(this, "48119", {
      "48122": obj,
      "48150": {
        args: (function() {
  ...
  sibilant.macros.namespaces.core.switch = (function switch$(obj, cases) {
    ...
    return [ "(function() {", indent([ "switch(", transpile(obj), ") {", map(cases, (function(caseDef) {
      ...
      return [ "\n", caseString, indent(macros.expandQuote.call(this, "49218", { "49222": caseDef.contents.slice(1) })) ];
    })), "}" ]), "}).call(this)" ];
  });
    ...
    return [ "(function() {", indent(interleave(" else ", bulkMap(alternatingConditionsAndBranches, (function(cond, val) {
      ...
      return (function() {
        if (typeof val !== "undefined") {
          return [ "if (", transpile(cond), ") {", indent(macros.expandQuote.call(this, "49843", { "49846": val })), "}" ];
        } else {
          return [ "{", indent(macros.expandQuote.call(this, "49929", { "49932": cond })), "}" ];
        }
      }).call(this);
    })))), "}).call(this)" ];
  });
  sibilant.macros.namespaces.core.chain = (function chain$(object, calls) {
    ...
    return (function() {
      if (0 === calls.length) {
        ...
        return macros.expandQuote.call(this, "50071", {
          "50074": object,
          "50078": calls[0].contents
        });
      } else {
  ...
  sibilant.macros.namespaces.core.chainable = (function chainable$(names) {
    ...
    return names.forEach((function(name) {
      ...
      return macros.expandQuote.call(this, "50408", { "50411": name });
    }));
  });
  ...
  sibilant.macros.namespaces.core["includes__QUERY"] = (function includes__QUERY$(haystack, needle) {
    ...
    return macros.expandQuote.call(this, "50603", {
      "50606": haystack,
      "50613": needle
    });
  });
  sibilant.macros.namespaces.core["excludes__QUERY"] = (function excludes__QUERY$(haystack, needle) {
    ...
    return macros.expandQuote.call(this, "50695", {
      "50698": haystack,
      "50705": needle
    });
  });
  sibilant.macros.namespaces.core["exists__QUERY"] = (function exists__QUERY$(thing) {
    ...
    return macros.expandQuote.call(this, "50760", {
      "50766": thing,
      "50773": thing
    });
  });
  ...
  sibilant.macros.namespaces.core.join = (function join$(arr, glue) {
    ...
    return macros.expandQuote.call(this, "51047", {
      "51051": arr,
      "51054": (glue || "\"\"")
    });
  });
      ...
      return (function() {
        ...
        case "bracket":
          ...
          lhs.contents.forEach((function(item, index) {
            ...
            return destructured.push([ transpile(item), macros.expandQuote.call(this, "51529", {
              "51532": symbol,
              "51535": index
            }) ]);
          }));
        ...
        case "brace":
          ...
          lhs.contents.forEach((function(item, index) {
            ...
            return destructured.push([ trItem, macros.expandQuote.call(this, "51862", {
              "51865": symbol,
              "51868": [ "\"", trItem, "\"" ]
            }) ]);
          }));
  ...
  sibilant.macros.namespaces.core.default = (function default$(pairs) {
    ...
    return interleave("\n", bulkMap(pairs, (function(name, value) {
      ...
      return macros.expandQuote.call(this, "52305", {
        "52308": name,
        "52317": name,
        "52321": name,
        "52324": value
  ...
  sibilant.macros.namespaces.core.namespace = (function namespace$(namespace) {
    ...
    macros.expandQuote.call(this, "52452", { "52455": namespace });
  ...
  sibilant.macros.namespaces.core["hasKey__QUERY"] = (function hasKey__QUERY$(object, key) {
    ...
    return macros.expandQuote.call(this, "52550", {
      "52554": object,
      "52557": key
    });
  });
  ...
  sibilant.macros.namespaces.core.set = (function set$(arr, kvPairs) {
    ...
    return interleave("\n", bulkMap(kvPairs, (function(k, v) {
      ...
      return macros.expandQuote.call(this, "53177", {
        "53183": arr,
        "53186": k,
        "53190": v
      });
  ...
  sibilant.macros.namespaces.core["lowerCase__QUERY"] = (function lowerCase__QUERY$(str) {
    ...
    return macros.expandQuote.call(this, "53236", {
      "53243": str,
      "53247": str
    });
  });
  sibilant.macros.namespaces.core["upperCase__QUERY"] = (function upperCase__QUERY$(str) {
    ...
    return macros.expandQuote.call(this, "53292", {
      "53299": str,
      "53303": str
    });
  });
  ...
  sibilant.packageInfo = (function sibilant$packageInfo$() {
    /* sibilant.package-info /Users/jbr/code/sibilant/src/browser.sibilant:40:3 */
  
    return package;
  });
  sibilant.versionString = (function sibilant$versionString$() {
    /* sibilant.version-string /Users/jbr/code/sibilant/src/browser.sibilant:42:3 */
  
    return (package.name + " browser version " + package.version);
  });
  sibilant.dir = "browser";
  return $((function() {
    /* /Users/jbr/code/sibilant/src/browser.sibilant:47:6 */
  
    var sibilant = root.sibilant,
        scripts = $.makeArray($("script[type=\"application/sibilant\"][src]").map((function() {
      /* /Users/jbr/code/sibilant/src/browser.sibilant:50:42 */
    
      return this.src;
    })));
    sibilant.initialize = (function sibilant$initialize$() {
      /* sibilant.initialize /Users/jbr/code/sibilant/src/browser.sibilant:52:7 */
    
      return false;
    });
    var evalCode = (function evalCode$(js) {
      /* eval-code /Users/jbr/code/sibilant/src/browser.sibilant:54:7 */
    
      return (new Function(js))();
    });
    sibilant.include = (function sibilant$include$(url) {
      /* sibilant.include /Users/jbr/code/sibilant/src/browser.sibilant:57:7 */
    
      return $.get(url).done((function() {
        /* /Users/jbr/code/sibilant/src/browser.sibilant:58:29 */

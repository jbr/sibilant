var sibilant = exports,
    ...
    fs = require("fs"),
    error = (function(str) {
  /* /Users/jbr/code/sibilant/src/sibilant.sibilant:5:14 */
...
var ast = (function ast$(input, parent) {
  /* ast /Users/jbr/code/sibilant/src/sibilant.sibilant:16:0 */
...
sibilant.initialize = (function sibilant$initialize$() {
  /* sibilant.initialize /Users/jbr/code/sibilant/src/sibilant.sibilant:20:0 */
...
var sibilize = (function sibilize$(input) {
  /* sibilize /Users/jbr/code/sibilant/src/sibilant.sibilant:25:0 */

  sibilant.initialize();
  return outputFormatter(transpile(restructure(parse(input))));
});
var sourcemap = (function sourcemap$(input) {
  /* sourcemap /Users/jbr/code/sibilant/src/sibilant.sibilant:29:0 */
...
sibilant.version = (function sibilant$version$() {
  /* sibilant.version /Users/jbr/code/sibilant/src/sibilant.sibilant:37:0 */

  return (sibilant.packageInfo())["version"];
});
sibilant.packageInfo = (function sibilant$packageInfo$() {
  /* sibilant.package-info /Users/jbr/code/sibilant/src/sibilant.sibilant:40:0 */

  var fs = require("fs");
  return JSON.parse(fs.readFileSync((__dirname + "/../package.json")));
});
sibilant.versionString = (function sibilant$versionString$() {
  /* sibilant.version-string /Users/jbr/code/sibilant/src/sibilant.sibilant:45:0 */
...
sibilant.stripShebang = (function sibilant$stripShebang$(data) {
  /* sibilant.strip-shebang /Users/jbr/code/sibilant/src/sibilant.sibilant:51:0 */
...
(require.extensions)[".sibilant"] = (function(module, filename) {
  /* /Users/jbr/code/sibilant/src/sibilant.sibilant:59:5 */

  var content = sibilant.sibilizeFile(filename);
  return module._compile(content, filename);
});
(require.extensions)[".son"] = (function(module, filename) {
  /* /Users/jbr/code/sibilant/src/sibilant.sibilant:64:5 */
...
sibilant.include = (function sibilant$include$(file) {
  /* sibilant.include /Users/jbr/code/sibilant/src/sibilant.sibilant:69:0 */
...
var withDirAndFile = (function withDirAndFile$(dir, file, fn) {
  /* with-dir-and-file /Users/jbr/code/sibilant/src/sibilant.sibilant:82:0 */
...
sibilant.sibilizeFile = (function sibilant$sibilizeFile$(fileName) {
  /* sibilant.sibilize-file /Users/jbr/code/sibilant/src/sibilant.sibilant:99:0 */

  return outputFormatter(sibilant.transpileFile(fileName));
});
sibilant.transpileFile = (function sibilant$transpileFile$(fileName) {
  /* sibilant.transpile-file /Users/jbr/code/sibilant/src/sibilant.sibilant:102:0 */

  return withDirAndFile(path.dirname(fileName), fileName, (function() {
    /* /Users/jbr/code/sibilant/src/sibilant.sibilant:104:24 */
...
sibilant.sourcemapFile = (function sibilant$sourcemapFile$(fileName) {
  /* sibilant.sourcemap-file /Users/jbr/code/sibilant/src/sibilant.sibilant:113:0 */

  return withDirAndFile(path.dirname(fileName), fileName, (function() {
    /* /Users/jbr/code/sibilant/src/sibilant.sibilant:115:24 */
...
sibilant.sibilizeJson = (function sibilant$sibilizeJson$(fileName) {
  /* sibilant.sibilize-json /Users/jbr/code/sibilant/src/sibilant.sibilant:120:0 */
...
sibilant.macros.include = (function sibilant$macros$include$(file) {
  /* sibilant.macros.include /Users/jbr/code/sibilant/src/sibilant.sibilant:128:0 */

...
sibilant.entry = (function sibilant$entry$(source, options) {
  ...
  (function() {
    if (((typeof file !== "undefined" && file !== null) && !((typeof source !== "undefined" && source !== null)))) {
      var temp$15 = relativeDirAndFile(file),
          relativeDir = temp$15[0],
          relativeFile = temp$15[1],
          temp$15 = undefined;
  ...
  (function() {
    if (file) {
      var temp$16 = relativeDirAndFile(file),
          relativeDir = temp$16[0],
          relativeFile = temp$16[1],
          temp$16 = undefined;
...
sibilant.transpileFile = (function sibilant$transpileFile$(fileName) {
  ...
  return withFile(fileName, (function() {
    ...
    var source = sibilant.stripShebang(fs.readFileSync(fileName, "utf8")),
        temp$17 = relativeDirAndFile(file),
        relativeDir = temp$17[0],
        relativeFile = temp$17[1],
        temp$17 = undefined;

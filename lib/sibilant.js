...
var sibilant = exports,
    ...
    fs = require("fs"),
    error = (function(str) {
  /* /Users/jbr/code/sibilant-clean/src/node.sibilant:5:14 */
...
sibilant.transpileFile = (function sibilant$transpileFile$(fileName) {
  /* sibilant.transpile-file /Users/jbr/code/sibilant-clean/src/node.sibilant:11:0 */

  return withDirAndFile(path.dirname(fileName), fileName, (function() {
    /* /Users/jbr/code/sibilant-clean/src/node.sibilant:13:24 */
...
sibilant.sourcemapFile = (function sibilant$sourcemapFile$(fileName) {
  /* sibilant.sourcemap-file /Users/jbr/code/sibilant-clean/src/node.sibilant:22:0 */

  return withDirAndFile(path.dirname(fileName), fileName, (function() {
    /* /Users/jbr/code/sibilant-clean/src/node.sibilant:24:24 */
  
    return sourcemap(sibilant.stripShebang(fs.readFileSync(fileName, "utf8")));
  }));
});
require.extensions[".sibilant"] = (function(module, filename) {
  /* /Users/jbr/code/sibilant-clean/src/node.sibilant:30:5 */

  var content = sibilant.sibilizeFile(filename);
  return module._compile(content, filename);
});
require.extensions[".son"] = (function(module, filename) {
  /* /Users/jbr/code/sibilant-clean/src/node.sibilant:35:5 */
...
sibilant.packageInfo = (function sibilant$packageInfo$() {
  /* sibilant.package-info /Users/jbr/code/sibilant-clean/src/node.sibilant:42:0 */

  var fs = require("fs");
  return JSON.parse(fs.readFileSync((__dirname + "/../package.json")));
});
sibilant.versionString = (function sibilant$versionString$() {
  /* sibilant.version-string /Users/jbr/code/sibilant-clean/src/node.sibilant:47:0 */
...
sibilant.initialize = (function sibilant$initialize$() {
  /* sibilant.initialize /Users/jbr/code/sibilant-clean/src/node.sibilant:54:0 */
...
sibilant.loadMacros = (function sibilant$loadMacros$() {
  /* sibilant.load-macros /Users/jbr/code/sibilant-clean/src/node.sibilant:61:0 */

  return sibilant.include(path.normalize((__dirname + "/../include/macros")));
});
sibilant.include = (function sibilant$include$(file) {
  /* sibilant.include /Users/jbr/code/sibilant-clean/src/node.sibilant:65:0 */
...
var log__BANG = (function log__BANG$(args) {
  /* log! /Users/jbr/code/sibilant-clean/src/colors.sibilant:1:0 */

  var args = Array.prototype.slice.call(arguments, 0);

  return inspect__BANG.apply(this, args).forEach((function() {
    /* /Users/jbr/code/sibilant-clean/src/colors.sibilant:2:35 */
  
    return console.log(arguments[0]);
  }));
});
var inspect__BANG = (function inspect__BANG$(args) {
  /* inspect! /Users/jbr/code/sibilant-clean/src/colors.sibilant:4:0 */

  var args = Array.prototype.slice.call(arguments, 0);

  return args.map((function() {
    /* /Users/jbr/code/sibilant-clean/src/colors.sibilant:5:15 */
...
var color = (function color$(code, items, depth) {
  /* color /Users/jbr/code/sibilant-clean/src/colors.sibilant:7:0 */

  return (code + items.join("") + "\033[0m");
});
var black = (function black$(args) {
  /* black /Users/jbr/code/sibilant-clean/src/colors.sibilant:10:0 */
...
var red = (function red$(args) {
  /* red /Users/jbr/code/sibilant-clean/src/colors.sibilant:11:0 */
...
var green = (function green$(args) {
  /* green /Users/jbr/code/sibilant-clean/src/colors.sibilant:12:0 */
...
var brown = (function brown$(args) {
  /* brown /Users/jbr/code/sibilant-clean/src/colors.sibilant:13:0 */
...
var blue = (function blue$(args) {
  /* blue /Users/jbr/code/sibilant-clean/src/colors.sibilant:14:0 */
...
var purple = (function purple$(args) {
  /* purple /Users/jbr/code/sibilant-clean/src/colors.sibilant:15:0 */
...
var cyan = (function cyan$(args) {
  /* cyan /Users/jbr/code/sibilant-clean/src/colors.sibilant:16:0 */
...
var gray = (function gray$(args) {
  /* gray /Users/jbr/code/sibilant-clean/src/colors.sibilant:17:0 */
...
var boldGray = (function boldGray$(args) {
  /* bold-gray /Users/jbr/code/sibilant-clean/src/colors.sibilant:18:0 */
...
var boldRed = (function boldRed$(args) {
  /* bold-red /Users/jbr/code/sibilant-clean/src/colors.sibilant:19:0 */
...
var boldGreen = (function boldGreen$(args) {
  /* bold-green /Users/jbr/code/sibilant-clean/src/colors.sibilant:20:0 */
...
var yellow = (function yellow$(args) {
  /* yellow /Users/jbr/code/sibilant-clean/src/colors.sibilant:21:0 */
...
var boldBlue = (function boldBlue$(args) {
  /* bold-blue /Users/jbr/code/sibilant-clean/src/colors.sibilant:22:0 */
...
var boldPurple = (function boldPurple$(args) {
  /* bold-purple /Users/jbr/code/sibilant-clean/src/colors.sibilant:23:0 */
...
var boldCyan = (function boldCyan$(args) {
  /* bold-cyan /Users/jbr/code/sibilant-clean/src/colors.sibilant:24:0 */
...
var white = (function white$(args) {
  /* white /Users/jbr/code/sibilant-clean/src/colors.sibilant:25:0 */
...
sibilant.prettyPrint = (function sibilant$prettyPrint$(node, color, entry) {
  /* sibilant.pretty-print /Users/jbr/code/sibilant-clean/src/pretty-printer.sibilant:3:0 */
  ...
  return realNewlines((function() {
    if (node__QUERY(node)) {
      ...
      return ((function() {
        ...
        /* /Users/jbr/code/sibilant-clean/src/pretty-printer.sibilant:14:28 */
...
sibilant.prettyPrint.default = (function sibilant$prettyPrint$default$(node, color, entry) {
  /* sibilant.pretty-print.default /Users/jbr/code/sibilant-clean/src/pretty-printer.sibilant:23:0 */

  var mapPretty = (function mapPretty$(attr) {
    /* map-pretty /Users/jbr/code/sibilant-clean/src/pretty-printer.sibilant:24:5 */
  
    var arr = node[attr];
    return (function() {
      if ((arr && arr.length)) {
        return map(arr, (function() {
          /* /Users/jbr/code/sibilant-clean/src/pretty-printer.sibilant:27:27 */
...
sibilant.prettyPrint.root = (function sibilant$prettyPrint$root$(node, color, entry) {
  /* sibilant.pretty-print.root /Users/jbr/code/sibilant-clean/src/pretty-printer.sibilant:39:0 */

  return map(node.contents, (function() {
    /* /Users/jbr/code/sibilant-clean/src/pretty-printer.sibilant:41:16 */
  
    return prettify(arguments[0], color, false);
  })).join("\n");
});
sibilant.prettyPrint.output = (function sibilant$prettyPrint$output$(node, color) {
  /* sibilant.pretty-print.output /Users/jbr/code/sibilant-clean/src/pretty-printer.sibilant:44:0 */
  ...
  return ((function() {
    ...
    if (((node.contents) && typeof (node.contents) === "object" && (node.contents).constructor.name === "Array")) {
      return map(node.contents, (function() {
        /* /Users/jbr/code/sibilant-clean/src/pretty-printer.sibilant:48:28 */
...
var realNewlines = (function realNewlines$(node) {
  /* real-newlines /Users/jbr/code/sibilant-clean/src/pretty-printer.sibilant:54:0 */

  return node.split("\\n")
    .join("\n");
});
sibilant.prettyPrint.colorize = (function sibilant$prettyPrint$colorize$(node, color, string) {
  /* sibilant.pretty-print.colorize /Users/jbr/code/sibilant-clean/src/pretty-printer.sibilant:57:0 */
...
var outputFormatter = (function outputFormatter$(node) {
  /* output-formatter /Users/jbr/code/sibilant-clean/src/output-formatter.sibilant:1:0 */
...
var sourceMap = (function sourceMap$(node) {
  /* source-map /Users/jbr/code/sibilant-clean/src/sourcemap.sibilant:3:0 */
...
var sourcemapper = (function sourcemapper$(node) {
  /* sourcemapper /Users/jbr/code/sibilant-clean/src/sourcemap.sibilant:17:0 */
  ...
  Object.keys(sibilant.sourceCache).forEach((function(key) {
    /* /Users/jbr/code/sibilant-clean/src/sourcemap.sibilant:21:5 */
...
var bulkMap = (function bulkMap$(arr, fn) {
  /* bulk-map /Users/jbr/code/sibilant-clean/include/functional.sibilant:1:0 */
...
var inject = (function inject$(start, items, fn) {
  /* inject /Users/jbr/code/sibilant-clean/include/functional.sibilant:13:0 */

  var value = start;
  (function() {
    if (((items) && typeof (items) === "object" && (items).constructor.name === "Array")) {
      return items.forEach((function(item, index) {
        /* /Users/jbr/code/sibilant-clean/include/functional.sibilant:16:4 */
...
var map = (function map$(items, fn) {
  /* map /Users/jbr/code/sibilant-clean/include/functional.sibilant:20:0 */

  return inject([], items, (function(collector, item, index) {
    /* /Users/jbr/code/sibilant-clean/include/functional.sibilant:22:10 */
...
var select = (function select$(items, fn) {
  /* select /Users/jbr/code/sibilant-clean/include/functional.sibilant:26:0 */

  return inject([], items, (function(collector, item, index) {
    /* /Users/jbr/code/sibilant-clean/include/functional.sibilant:28:10 */
...
var detect = (function detect$(items, fn) {
  /* detect /Users/jbr/code/sibilant-clean/include/functional.sibilant:33:0 */
...
var all__QUERY = (function all__QUERY$(items, fn) {
  /* all? /Users/jbr/code/sibilant-clean/include/functional.sibilant:45:0 */

  return typeof detect(items, (function(item, index) {
    /* /Users/jbr/code/sibilant-clean/include/functional.sibilant:46:31 */
  
    return !(fn(item, index));
  })) === "undefined";
});
var none__QUERY = (function none__QUERY$(items, fn) {
  /* none? /Users/jbr/code/sibilant-clean/include/functional.sibilant:48:0 */

  return typeof detect(items, fn) === "undefined";
});
var any__QUERY = (function any__QUERY$(items, fn) {
  /* any? /Users/jbr/code/sibilant-clean/include/functional.sibilant:51:0 */

  return typeof detect(items, fn) !== "undefined";
});
var reject = (function reject$(items, fn) {
  /* reject /Users/jbr/code/sibilant-clean/include/functional.sibilant:54:0 */

  var args = [ items, fn ];
  return select(items, (function() {
    /* /Users/jbr/code/sibilant-clean/include/functional.sibilant:56:16 */
  
    return !(fn.apply(this, arguments));
  }));
});
var compact = (function compact$(arr) {
  /* compact /Users/jbr/code/sibilant-clean/include/functional.sibilant:58:0 */

  return select(arr, (function(item) {
    /* /Users/jbr/code/sibilant-clean/include/functional.sibilant:59:17 */
  
    return (null !== item && false !== item && typeof item !== "undefined");
  }));
});
var interleave = (function interleave$(glue, arr) {
  /* interleave /Users/jbr/code/sibilant-clean/include/functional.sibilant:65:0 */
  ...
  return (function() {
    if (((glue) && typeof (glue) === "object" && (glue).constructor.name === "Array")) {
      return inject([], arr, (function(collector, item, index) {
        /* /Users/jbr/code/sibilant-clean/include/functional.sibilant:72:13 */
      
        return collector.concat([ item, glue[index] ]);
      }));
    } else {
      return inject([ arr[0] ], arr.slice(1), (function(collector, item, index) {
        /* /Users/jbr/code/sibilant-clean/include/functional.sibilant:77:13 */
...
var flatten = (function flatten$(items) {
  /* flatten /Users/jbr/code/sibilant-clean/include/functional.sibilant:80:0 */

  var items = Array.prototype.slice.call(arguments, 0);

  return inject([], items, (function(collector, item) {
    /* /Users/jbr/code/sibilant-clean/include/functional.sibilant:82:10 */
...
var recurseMap = (function recurseMap$(item, fn) {
  /* recurse-map /Users/jbr/code/sibilant-clean/include/functional.sibilant:89:0 */

  return (function() {
    if (((item) && typeof (item) === "object" && (item).constructor.name === "Array")) {
      return map(item, (function(subitem) {
        /* /Users/jbr/code/sibilant-clean/include/functional.sibilant:90:32 */
...
var pluck = (function pluck$(items, attribute) {
  /* pluck /Users/jbr/code/sibilant-clean/include/functional.sibilant:93:0 */

  return map(items, (function(item) {
    /* /Users/jbr/code/sibilant-clean/include/functional.sibilant:94:16 */
  
    return item[attribute];
  }));
});
var mergeInto = (function mergeInto$(into, from) {
  /* merge-into /Users/jbr/code/sibilant-clean/include/functional.sibilant:96:0 */

  Object.keys(from).forEach((function(key) {
    /* /Users/jbr/code/sibilant-clean/include/functional.sibilant:97:5 */
...
var clone = (function clone$(object) {
  /* clone /Users/jbr/code/sibilant-clean/include/functional.sibilant:100:0 */

  return inject({  }, Object.keys(object), (function(collector, key) {
    /* /Users/jbr/code/sibilant-clean/include/functional.sibilant:102:13 */
...
var mapValues = (function mapValues$(object, fn) {
  /* map-values /Users/jbr/code/sibilant-clean/include/functional.sibilant:106:0 */

  return inject({  }, Object.keys(object), (function(collector, key, index) {
    /* /Users/jbr/code/sibilant-clean/include/functional.sibilant:108:13 */
...
var mergeWith = (function mergeWith$(into, from) {
  /* merge-with /Users/jbr/code/sibilant-clean/include/functional.sibilant:112:0 */
...
parser.orderedRegexes = parser.tokenPrecedence.map((function(x) {
  /* /Users/jbr/code/sibilant-clean/src/parser.sibilant:41:23 */
...
var nodeId = (function nodeId$(node) {
  /* node-id /Users/jbr/code/sibilant-clean/src/parser.sibilant:48:0 */

  return ((nodeId.lastId)++);
});
var cacheNode = (function cacheNode$(node) {
  /* cache-node /Users/jbr/code/sibilant-clean/src/parser.sibilant:51:0 */
...
parser.parse = (function parser$parse$(string, context) {
  /* parser.parse /Users/jbr/code/sibilant-clean/src/parser.sibilant:58:0 */
    ...
    while (match) {
      $_symbol3_$ = (function() {
        detect(orderedRegexes, (function(r) {
          /* /Users/jbr/code/sibilant-clean/src/parser.sibilant:70:20 */
...
var restructure = (function restructure$(input) {
  /* restructure /Users/jbr/code/sibilant-clean/src/restructurer.sibilant:7:0 */
  ...
  inject(context, input, (function(context, token, index) {
    /* /Users/jbr/code/sibilant-clean/src/restructurer.sibilant:20:13 */
...
restructurers.openExpression = (function restructurers$openExpression$(token, context) {
  /* restructurers.open-expression /Users/jbr/code/sibilant-clean/src/restructurer.sibilant:31:0 */
...
restructurers.closeExpression = (function restructurers$closeExpression$(node, context, index) {
  /* restructurers.close-expression /Users/jbr/code/sibilant-clean/src/restructurer.sibilant:43:0 */
...
var openSpecial = (function openSpecial$(node, context) {
  /* open-special /Users/jbr/code/sibilant-clean/src/restructurer.sibilant:68:0 */
...
var acceptSpecials = (function acceptSpecials$(node, context) {
  /* accept-specials /Users/jbr/code/sibilant-clean/src/restructurer.sibilant:81:0 */
...
var acceptIgnoredTokens = (function acceptIgnoredTokens$(node, context) {
  /* accept-ignored-tokens /Users/jbr/code/sibilant-clean/src/restructurer.sibilant:86:0 */
...
var closeSpecials = (function closeSpecials$(node, context) {
  /* close-specials /Users/jbr/code/sibilant-clean/src/restructurer.sibilant:91:0 */
...
var accumulateIgnoredToken = (function accumulateIgnoredToken$(token, context, index) {
  /* accumulate-ignored-token /Users/jbr/code/sibilant-clean/src/restructurer.sibilant:99:0 */

  context.ignoredTokens.push(token);
  return context;
});
[ "hat", "dots", "tick", "at" ].forEach((function(special) {
  /* /Users/jbr/code/sibilant-clean/src/restructurer.sibilant:103:0 */

  return restructurers[special] = openSpecial;
}));
[ "whitespace", "newline", "ignored" ].forEach((function(ignored) {
  /* /Users/jbr/code/sibilant-clean/src/restructurer.sibilant:106:0 */
...
restructurers.default = (function restructurers$default$(token, context, index) {
  /* restructurers.default /Users/jbr/code/sibilant-clean/src/restructurer.sibilant:109:0 */
...
sibilant.macros.currentNamespace = (function sibilant$macros$currentNamespace$() {
  /* sibilant.macros.current-namespace /Users/jbr/code/sibilant-clean/src/macros.sibilant:14:0 */
...
sibilant.resolveMacro = (function sibilant$resolveMacro$(macroName) {
  /* sibilant.resolve-macro /Users/jbr/code/sibilant-clean/src/macros.sibilant:17:0 */
  ...
  return (function() {
    if ((macroName.indexOf("/") !== -1 && 1 < macroName.length && !(macroName.indexOf("\n") !== -1))) {
      ...
      var namespace = detect(sibilant.macros.searchPath, (function(namespace) {
        /* /Users/jbr/code/sibilant-clean/src/macros.sibilant:29:28 */
...
sibilant.withDefaultSearchPath = (function sibilant$withDefaultSearchPath$(fn) {
  /* sibilant.with-default-search-path /Users/jbr/code/sibilant-clean/src/macros.sibilant:34:0 */
...
var tap = (function tap$(item, fn) {
  /* tap /Users/jbr/code/sibilant-clean/src/helpers.sibilant:3:0 */

  fn(item);
  return item;
});
var recurseIndent = (function recurseIndent$(args) {
  /* recurse-indent /Users/jbr/code/sibilant-clean/src/helpers.sibilant:7:0 */

  var args = Array.prototype.slice.call(arguments, 0);

  return map(args, (function(arg) {
    /* /Users/jbr/code/sibilant-clean/src/helpers.sibilant:9:10 */
...
var indent = (function indent$(args) {
  /* indent /Users/jbr/code/sibilant-clean/src/helpers.sibilant:24:0 */
...
var escapeRegex = (function escapeRegex$(string) {
  /* escape-regex /Users/jbr/code/sibilant-clean/src/helpers.sibilant:27:0 */

  return string.replace((new RegExp("[\\-\\[\\]\\/\\{\\}\\(\\)\\*\\+\\?\\.\\\\\^\\$\\|]", "g")), "\\$&");
});
var qescape = (function qescape$(content) {
  /* qescape /Users/jbr/code/sibilant-clean/src/helpers.sibilant:30:0 */
...
var mapNode = (function mapNode$(node, fn) {
  /* map-node /Users/jbr/code/sibilant-clean/src/helpers.sibilant:39:0 */
  ...
  return (function() {
    if (node__QUERY(node)) {
      ...
      return map(node, (function() {
        /* /Users/jbr/code/sibilant-clean/src/helpers.sibilant:48:32 */
...
var eachNode = (function eachNode$(node, fn) {
  /* each-node /Users/jbr/code/sibilant-clean/src/helpers.sibilant:51:0 */
  ...
  return (function() {
    if (node__QUERY(node)) {
      ...
      return node.forEach((function(c) {
        /* /Users/jbr/code/sibilant-clean/src/helpers.sibilant:53:22 */
...
var statement__QUERY = (function statement__QUERY$(transpiled) {
  /* statement? /Users/jbr/code/sibilant-clean/src/helpers.sibilant:56:0 */
...
var asStatement = (function asStatement$(node) {
  /* as-statement /Users/jbr/code/sibilant-clean/src/helpers.sibilant:62:0 */
...
var unquote__QUERY = (function unquote__QUERY$(node) {
  /* unquote? /Users/jbr/code/sibilant-clean/src/helpers.sibilant:69:0 */

  return node__QUERY(node, "at");
});
var findUnquotes = (function findUnquotes$(node) {
  /* find-unquotes /Users/jbr/code/sibilant-clean/src/helpers.sibilant:71:0 */

  var unquotes = {  };
  eachNode(node, (function(n) {
    /* /Users/jbr/code/sibilant-clean/src/helpers.sibilant:73:21 */
...
var spliceDots = (function spliceDots$(node) {
  /* splice-dots /Users/jbr/code/sibilant-clean/src/helpers.sibilant:79:0 */
  ...
  (function() {
    if ((node && ((node.contents) && typeof (node.contents) === "object" && (node.contents).constructor.name === "Array"))) {
      ...
      node.contents.forEach((function(content) {
        /* /Users/jbr/code/sibilant-clean/src/helpers.sibilant:82:11 */
...
var alternatingKeysAndValues = (function alternatingKeysAndValues$(hash) {
  /* alternating-keys-and-values /Users/jbr/code/sibilant-clean/src/helpers.sibilant:94:0 */

  return flatten(map(Object.keys(hash), (function(key) {
    /* /Users/jbr/code/sibilant-clean/src/helpers.sibilant:96:19 */
  
    return [ key, hash[key] ];
  })));
});
var mapNodeForQuoteExpansion = (function mapNodeForQuoteExpansion$(node, expansions) {
  /* map-node-for-quote-expansion /Users/jbr/code/sibilant-clean/src/helpers.sibilant:99:0 */
  ...
  return (function() {
    if (node__QUERY(node)) {
      ...
      return map(node, (function() {
        /* /Users/jbr/code/sibilant-clean/src/helpers.sibilant:110:19 */
...
docs.record = (function docs$record$(type, namespace, name, node) {
  /* docs.record /Users/jbr/code/sibilant-clean/src/docs.sibilant:4:0 */
...
docs.tags = (function docs$tags$() {
  /* docs.tags /Users/jbr/code/sibilant-clean/src/docs.sibilant:16:0 */

  var tags = flatten(pluck(docs.definitions, "tags")),
      counts = {  };
  tags.forEach((function(tag) {
    /* /Users/jbr/code/sibilant-clean/src/docs.sibilant:19:5 */
...
docs.text = (function docs$text$() {
  /* docs.text /Users/jbr/code/sibilant-clean/src/docs.sibilant:25:0 */

  return docs.definitions.map((function(definition) {
    /* /Users/jbr/code/sibilant-clean/src/docs.sibilant:27:15 */
    ...
    return ("name: " + definition.type + " " + definition.namespace + "/" + prettify(definition.name) + "\n" + "description: " + definition.docString + "\n" + (function() {
      if (definition.references) {
        return ("references:\n  " + (definition.references.map((function() {
          /* /Users/jbr/code/sibilant-clean/src/docs.sibilant:33:51 */
      ...
      /* /Users/jbr/code/sibilant-clean/src/docs.sibilant:45:43 */
...
docs.textNoColor = (function docs$textNoColor$() {
  /* docs.text-no-color /Users/jbr/code/sibilant-clean/src/docs.sibilant:52:0 */

  var stripAnsi = require("strip-ansi");
  return stripAnsi(docs.text());
});
docs.json = (function docs$json$() {
  /* docs.json /Users/jbr/code/sibilant-clean/src/docs.sibilant:56:0 */

  return JSON.stringify(docs.data());
});
docs.data = (function docs$data$() {
  /* docs.data /Users/jbr/code/sibilant-clean/src/docs.sibilant:59:0 */

  return docs.definitions.map((function(definition) {
    /* /Users/jbr/code/sibilant-clean/src/docs.sibilant:61:6 */
    ...
    return {
      ...
      references: (function() {
        if (definition.references) {
          return definition.references.map((function() {
            /* /Users/jbr/code/sibilant-clean/src/docs.sibilant:67:52 */
      ...
      arguments: definition.definition.contents[2].contents.map((function() {
        /* /Users/jbr/code/sibilant-clean/src/docs.sibilant:72:30 */
      ...
      examples: (definition.examples || []).map((function() {
        /* /Users/jbr/code/sibilant-clean/src/docs.sibilant:75:30 */
...
sibilant.macros.namespaces.core.return = (function sibilant$macros$namespaces$core$return$(token) {
  /* ^return /Users/jbr/code/sibilant-clean/src/core.sibilant:1:0 */
...
sibilant.macros.namespaces.core.do = (function sibilant$macros$namespaces$core$do$(body) {
  /* ^do /Users/jbr/code/sibilant-clean/src/core.sibilant:48:0 */
  ...
  return (function() {
    if (1 === body.length) {
      ...
      return [ interleave(map(body.slice(0, -1), (function() {
        /* /Users/jbr/code/sibilant-clean/src/core.sibilant:56:19 */
...
sibilant.macros.namespaces.core.emptyList = (function sibilant$macros$namespaces$core$emptyList$() {
  /* ^empty-list /Users/jbr/code/sibilant-clean/src/core.sibilant:64:0 */

  return "null";
});
sibilant.macros.namespaces.core.def = (function sibilant$macros$namespaces$core$def$(fnName, args, body) {
  /* ^def /Users/jbr/code/sibilant-clean/src/core.sibilant:66:0 */
...
sibilant.macros.namespaces.core.macro = (function sibilant$macros$namespaces$core$macro$(name, args, body) {
  /* ^macro /Users/jbr/code/sibilant-clean/src/core.sibilant:78:0 */
...
sibilant.macros.namespaces.core.meta = (function sibilant$macros$namespaces$core$meta$(body) {
  /* ^meta /Users/jbr/code/sibilant-clean/src/core.sibilant:93:0 */
...
sibilant.macros.namespaces.core.concat = (function sibilant$macros$namespaces$core$concat$(args) {
  /* ^concat /Users/jbr/code/sibilant-clean/src/core.sibilant:99:0 */
...
sibilant.macros.namespaces.core.reverse = (function sibilant$macros$namespaces$core$reverse$(arr) {
  /* ^reverse /Users/jbr/code/sibilant-clean/src/core.sibilant:102:0 */

  var reversed = [];
  arr.forEach((function(item) {
    /* /Users/jbr/code/sibilant-clean/src/core.sibilant:104:5 */
...
sibilant.macros.namespaces.core.lambda = (function sibilant$macros$namespaces$core$lambda$(argsOrOptions, body) {
  /* ^lambda /Users/jbr/code/sibilant-clean/src/core.sibilant:109:0 */
...
sibilant.macros.namespaces.core.quotedHash = (function sibilant$macros$namespaces$core$quotedHash$(pairs) {
  /* ^quoted-hash /Users/jbr/code/sibilant-clean/src/core.sibilant:145:0 */
...
sibilant.macros.namespaces.core.hash = (function sibilant$macros$namespaces$core$hash$(pairs) {
  /* ^hash /Users/jbr/code/sibilant-clean/src/core.sibilant:152:0 */
  ...
  var quoteKeys = sibilant.quoteHashKeys,
    ...
    /* /Users/jbr/code/sibilant-clean/src/core.sibilant:158:39 */
...
var replace__BANG = (function replace__BANG$(content) {
  /* replace! /Users/jbr/code/sibilant-clean/src/core.sibilant:168:0 */
  ...
  return (function() {
    if ((node__QUERY(content, "dots") && 3 === content.token.length && node__QUERY(content.contents[0], "at"))) {
      ...
      return sibilant.macros.namespaces.core.hash.apply(this, Object.keys(content).reduce((function() {
        /* /Users/jbr/code/sibilant-clean/src/core.sibilant:186:21 */
...
var prettyLogAndReturn = (function prettyLogAndReturn$(content) {
  /* pretty-log-and-return /Users/jbr/code/sibilant-clean/src/core.sibilant:199:0 */
...
sibilant.macros.namespaces.core.quote = (function sibilant$macros$namespaces$core$quote$(content) {
  /* ^quote /Users/jbr/code/sibilant-clean/src/core.sibilant:203:0 */
...
sibilant.macros.namespaces.core.debug = (function sibilant$macros$namespaces$core$debug$(val) {
  /* ^debug /Users/jbr/code/sibilant-clean/src/core.sibilant:226:0 */
...
sibilant.macros.namespaces.core.expandQuote = (function sibilant$macros$namespaces$core$expandQuote$(node, expansions) {
  /* ^expand-quote /Users/jbr/code/sibilant-clean/src/core.sibilant:229:0 */
...
sibilant.macros.namespaces.core.list = (function sibilant$macros$namespaces$core$list$(args) {
  /* ^list /Users/jbr/code/sibilant-clean/src/core.sibilant:235:0 */
  ...
  return (function() {
    if (0 === args.length) {
      ...
      var simpleList = (function simpleList$(args) {
        /* simple-list /Users/jbr/code/sibilant-clean/src/core.sibilant:239:12 */
      
        return [ "[ ", interleave(", ", map(args, (function(arg) {
          /* /Users/jbr/code/sibilant-clean/src/core.sibilant:240:50 */
        
          return arg.transpiled;
        }))), " ]" ];
      });
      args.forEach((function(arg) {
        /* /Users/jbr/code/sibilant-clean/src/core.sibilant:242:27 */
      ...
      argSegments = map(argSegments, (function(segment) {
        /* /Users/jbr/code/sibilant-clean/src/core.sibilant:248:38 */
...
sibilant.macros.namespaces.core.call = (function sibilant$macros$namespaces$core$call$(fnName, args) {
  /* ^call /Users/jbr/code/sibilant-clean/src/core.sibilant:258:0 */

  var args = Array.prototype.slice.call(arguments, 1);

  return (function() {
    if (any__QUERY(args, (function() {
      /* /Users/jbr/code/sibilant-clean/src/core.sibilant:259:20 */
...
sibilant.macros.namespaces.core.dots = (function sibilant$macros$namespaces$core$dots$(contents) {
  /* ^dots /Users/jbr/code/sibilant-clean/src/core.sibilant:264:0 */
...
sibilant.macros.namespaces.core.include = (function sibilant$macros$namespaces$core$include$(files) {
  /* ^include /Users/jbr/code/sibilant-clean/src/core.sibilant:267:0 */

  var files = Array.prototype.slice.call(arguments, 0);

  return interleave(files.map((function(file) {
    /* /Users/jbr/code/sibilant-clean/src/core.sibilant:269:17 */
  
    return sibilant.withDefaultSearchPath((function() {
      /* /Users/jbr/code/sibilant-clean/src/core.sibilant:271:20 */
...
sibilant.macros.namespaces.core.docs = (function sibilant$macros$namespaces$core$docs$(options) {
  /* ^docs /Users/jbr/code/sibilant-clean/src/core.sibilant:278:0 */
  ...
  bulkMap(options, (function(key, value) {
    /* /Users/jbr/code/sibilant-clean/src/core.sibilant:289:23 */
  
    return optionsHash[outputFormatter(transpile(key))] = value;
  }));
  [ "examples", "references" ].forEach((function(listAttribute) {
    /* /Users/jbr/code/sibilant-clean/src/core.sibilant:292:5 */
...
var node__QUERY = (function node__QUERY$(thing, types) {
  /* node? /Users/jbr/code/sibilant-clean/src/transpiler.sibilant:1:0 */
...
var emptyNode__QUERY = (function emptyNode__QUERY$(item) {
  /* empty-node? /Users/jbr/code/sibilant-clean/src/transpiler.sibilant:9:0 */
...
var compactNode = (function compactNode$(item) {
  /* compact-node /Users/jbr/code/sibilant-clean/src/transpiler.sibilant:17:0 */
...
var recurseTranspile = (function recurseTranspile$(node) {
  /* recurse-transpile /Users/jbr/code/sibilant-clean/src/transpiler.sibilant:26:0 */
...
var transpile = (function transpile$(node, preprocessor) {
  /* transpile /Users/jbr/code/sibilant-clean/src/transpiler.sibilant:38:0 */
...
transpile.hat = (function transpile$hat$(node) {
  /* transpile.hat /Users/jbr/code/sibilant-clean/src/transpiler.sibilant:78:0 */
...
transpile.tick = (function transpile$tick$(node) {
  /* transpile.tick /Users/jbr/code/sibilant-clean/src/transpiler.sibilant:89:0 */

  return sibilant.macros.namespaces.core.quote.apply(node, node.contents);
});
transpile.at = (function transpile$at$(node) {
  /* transpile.at /Users/jbr/code/sibilant-clean/src/transpiler.sibilant:92:0 */

  return transpile(node.contents[0]);
});
transpile.dots = (function transpile$dots$(node) {
  /* transpile.dots /Users/jbr/code/sibilant-clean/src/transpiler.sibilant:95:0 */

  return sibilant.macros.namespaces.core.dots.apply(node, node.contents);
});
transpile.default = (function transpile$default$(node) {
  /* transpile.default /Users/jbr/code/sibilant-clean/src/transpiler.sibilant:98:0 */

  return node.token;
});
transpile.output = (function transpile$output$(node) {
  /* transpile.output /Users/jbr/code/sibilant-clean/src/transpiler.sibilant:101:0 */

  return node;
});
transpile.number = (function transpile$number$(node) {
  /* transpile.number /Users/jbr/code/sibilant-clean/src/transpiler.sibilant:104:0 */

  return parseFloat(node.token.replace((new RegExp(",", "g")), "")).toString();
});
transpile.root = (function transpile$root$(node) {
  /* transpile.root /Users/jbr/code/sibilant-clean/src/transpiler.sibilant:110:0 */
...
transpile.expression = (function transpile$expression$(node, preprocessor) {
  /* transpile.expression /Users/jbr/code/sibilant-clean/src/transpiler.sibilant:119:0 */
...
transpile.literal = (function transpile$literal$(node) {
  ...
  return inject(string.replace((new RegExp("\\*", "g")), "_")
    ...
    /* /Users/jbr/code/sibilant-clean/src/transpiler.sibilant:157:13 */
  
    return returnString.replace(match, match[1].toUpperCase());
  }));
});
transpile.string = (function transpile$string$(node) {
  /* transpile.string /Users/jbr/code/sibilant-clean/src/transpiler.sibilant:161:0 */

  return node.token.split("\n")
    .join("\\n\" +\n\"");
});
transpile.comment = (function transpile$comment$(node) {
  /* transpile.comment /Users/jbr/code/sibilant-clean/src/transpiler.sibilant:166:0 */

  return null;
});
var sibilize = (function sibilize$(input) {
  /* sibilize /Users/jbr/code/sibilant-clean/src/require-and-include.sibilant:1:0 */
...
var sourcemap = (function sourcemap$(input) {
  /* sourcemap /Users/jbr/code/sibilant-clean/src/require-and-include.sibilant:11:0 */
...
sibilant.version = (function sibilant$version$() {
  /* sibilant.version /Users/jbr/code/sibilant-clean/src/require-and-include.sibilant:17:0 */

  return sibilant.packageInfo().version;
});
sibilant.stripShebang = (function sibilant$stripShebang$(data) {
  /* sibilant.strip-shebang /Users/jbr/code/sibilant-clean/src/require-and-include.sibilant:20:0 */

  return data.replace((new RegExp("^#!.*\\n", undefined)), "\n");
});
sibilant.file = "eval.sibilant";
var withDirAndFile = (function withDirAndFile$(dir, file, fn) {
  /* with-dir-and-file /Users/jbr/code/sibilant-clean/src/require-and-include.sibilant:25:0 */
...
sibilant.sibilizeFile = (function sibilant$sibilizeFile$(fileName) {
  /* sibilant.sibilize-file /Users/jbr/code/sibilant-clean/src/require-and-include.sibilant:42:0 */

  return outputFormatter(sibilant.transpileFile(fileName));
});
sibilant.sibilizeJson = (function sibilant$sibilizeJson$(fileName) {
  /* sibilant.sibilize-json /Users/jbr/code/sibilant-clean/src/require-and-include.sibilant:47:0 */

...
sibilant.entry = (function sibilant$entry$(source, options) {
  ...
  (function() {
    if (((typeof file !== "undefined" && file !== null) && !((typeof source !== "undefined" && source !== null)))) {
      var relativeDirAndFile$4 = relativeDirAndFile(file),
          relativeDir = relativeDirAndFile$4[0],
          relativeFile = relativeDirAndFile$4[1],
          relativeDirAndFile$4 = undefined;
      return source = (sibilant.sourceCache[relativeFile] || sibilant.stripShebang(fs.readFileSync(file, "utf8")));
    }
  }).call(this);
  (function() {
    if (file) {
      var relativeDirAndFile$5 = relativeDirAndFile(file),
          relativeDir = relativeDirAndFile$5[0],
          relativeFile = relativeDirAndFile$5[1],
          relativeDirAndFile$5 = undefined;
...
sibilant.transpileFile = (function sibilant$transpileFile$(fileName) {
  ...
  return withFile(fileName, (function() {
    ...
    var source = sibilant.stripShebang(fs.readFileSync(fileName, "utf8")),
        relativeDirAndFile$6 = relativeDirAndFile(file),
        relativeDir = relativeDirAndFile$6[0],
        relativeFile = relativeDirAndFile$6[1],
        relativeDirAndFile$6 = undefined;
  ...
  return {
    ...
    contents: [ {
      ...
      contents: [ {
        ...
        specials: 0,
        precedingIgnored: []
      }, pattern, {"dir":"include","file":"include/macros.sibilant","token":"'","type":"tick","start":20523,"line":621,"col":42,"length":1,"contents":[{"dir":"include","file":"include/macros.sibilant","token":"g","type":"literal","start":20524,"line":621,"col":43,"length":1,"contents":[],"specials":0,"precedingIgnored":[]}],"precedingIgnored":[{"dir":"include","file":"include/macros.sibilant","token":" ","type":"whitespace","start":20522,"line":621,"col":41,"length":1,"contents":[]}]} ],
      precedingIgnored: [ {
        dir: "include",
        file: "include/macros.sibilant",
        token: " ",
...
sibilant.macros.namespaces.core.hash = (function hash$(pairs) {
  /* hash include/macros.sibilant:1299:7 */

  var pairs = Array.prototype.slice.call(arguments, 0);

  pairs = pairs.map((function(p, i) {
    /* include/macros.sibilant:1300:32 */
  ...
  var pairs_reduce$3 = pairs.reduce((function(o, item, i) {
    /* include/macros.sibilant:1313:26 */
  ...
  var quoteKeys = sibilant.quoteHashKeys,
    ...
    /* include/macros.sibilant:1324:47 */
...
sibilant.macros.namespaces.core.quote = (function quote$(content) {
  /* quote include/macros.sibilant:1343:0 */
  ...
  return (function() {
    if (0 === args.length) {
      ...
      var simpleList = (function simpleList$(args) {
        /* simple-list include/macros.sibilant:1381:12 */
      
        return [ "[ ", interleave(", ", map(args, (function(arg) {
          /* include/macros.sibilant:1382:50 */
        
          return arg.transpiled;
        }))), " ]" ];
      });
      args.forEach((function(arg) {
        /* include/macros.sibilant:1384:27 */
      ...
      argSegments = map(argSegments, (function(segment) {
        /* include/macros.sibilant:1390:38 */
...
sibilant.macros.namespaces.core.call = (function call$(fnName, args) {
  /* call include/macros.sibilant:1407:0 */

  var args = Array.prototype.slice.call(arguments, 1);

  return (function() {
    if (any__QUERY(args, (function() {
      /* include/macros.sibilant:1408:20 */
...
sibilant.macros.namespaces.core.dots = (function dots$(contents) {
  /* dots include/macros.sibilant:1413:0 */
...
sibilant.macros.namespaces.core.docs = (function docs$(options) {
  /* docs include/macros.sibilant:1440:0 */
...
sibilant.macros.namespaces.core.tap = (function tap$(thing, body) {
  /* tap include/macros.sibilant:1484:0 */

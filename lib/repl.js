...
var displayPrompt = (function() {
  readline.setPrompt((((cmdBuffer.length > 10) ?
    ("..." + cmdBuffer.slice(-10))
    : // if (cmdBuffer.length > 10) is false
    ((cmdBuffer.length > 0) ?
      cmdBuffer
      : // if (cmdBuffer.length > 0) is false
      "sibilant"
    )
  ) + "> "));
...
readline.on("line", (function(cmd) {
  ...
  (function() {
    try {
      ...
      return (e.message.match("unexpected EOF") ?
        (function() {
          cmdBuffer = (cmdBuffer + " ");;
          return readline.history.shift();;
        })()
        : // if e.message.match("unexpected EOF") is false
        (function() {
          (readline.history)[0] = cmdBuffer;;

...
* Prefer readable and idiomatic javascript output, which necessitates sticking fairly closely to javascript semantics. Switching cost from sibilant to javascript should be low.
...
@$ sibilant test/test.sib -o . # put test.js here@ or @$ sibilant --input test/test.sib --output .@
...
h2. Learning the language and examples
...
Also, check out "macros.sib":http://github.com/jbr/sibilant/blob/master/lib/macros.sib to see how easy it is to write new compiler macros.

h2. How to get involved or learn more

Send a blank email to "sibilant@librelist.com":mailto:sibilant@librelist.com to join the mailing list.
Add any bugs or feature requests to the "issues":http://github.com/jbr/sibilant/issues page or email the list.

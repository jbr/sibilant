...
@$ sibilant test/test.sibilant -o . # put test.js here@ or @$ sibilant --input test/test.sibilant --output .@
...
Also, check out "macros.sibilant":http://github.com/jbr/sibilant/blob/master/lib/macros.sibilant to see how easy it is to write new compiler macros.
